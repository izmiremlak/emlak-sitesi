                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <form role="form" class="form-horizontal"  id="forms" method="POST" action="ajax.php?p=yazi_duzenle&id=<?=$snc->id;?>" onsubmit="return false;" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<p style="margin-left:10px;font-size:13px;margin-top:5px;">Yükleyeceğiniz görselin boyutları <?=$gorsel_boyutlari['yazilar']['resim1']['thumb_x']; ?> x <?=$gorsel_boyutlari['yazilar']['resim1']['thumb_y']; ?> px olmalıdır.</p>
                                        </div>
                                        </div>
										...
										<div class="form-group">
											...
											<p style="margin-left:10px;font-size:13px;margin-top:5px;">Yükleyeceğiniz görselin boyutları <?=$gorsel_boyutlari['yazilar']['resim2']['orjin_x']; ?> x <?=$gorsel_boyutlari['yazilar']['resim2']['orjin_y']; ?> px olmalıdır.</p>
                                        </div>
                                        </div>
