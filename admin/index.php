        ...
        <div class="left side-menu">
            <div class="sidebar-inner slimscrollleft">
                <div class="user-details">
                    <div class="pull-left"><img src="<?=($hesap->avatar == '') ? 'https://www.turkiyeemlaksitesi.com.tr/assets/images/users/no-avatar.png' : 'https://www.turkiyeemlaksitesi.com.tr/uploads/'.$hesap->avatar;?>" alt="" class="thumb-md img-circle"></div>
                    <div class="user-info">
