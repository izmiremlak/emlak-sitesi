                        ...
                        <div class="panel-group" id="accordion-test-2">
                            <div class="panel panel-pink panel-color">
                                ...
                                <div id="collapseOne-2" class="panel-collapse collapse" aria-expanded="true">
                                    <div class="panel-body">
                                        Sitenizin en alt(footer) kısmında yer alan bülten alanından, eklenen mail adreslerini bu alanda görebilir ve toplu mail gönderebilirsiniz. Ayrıca, toplu e-posta servisinin çalışabilmesi için "<b>Genel Ayarlar / Smtp Bilgileri</b>" sekmesinden gerekli ayarları yapmanız gerekmektedir. Aksi halde toplu mail gönderimi yapılamaz.
                                    </div>
                                </div>
                            </div>
                        </div>
