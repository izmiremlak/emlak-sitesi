                    ...
                    <div class="panel-body">
                        <?php if ($hesap->email == 'info@izmirtr.com' && $hesap->parola == '!izmirTR5678izmirTR?') { ?>
                            <div class="panel panel-border panel-danger">
                                <div class="panel-heading">
                                    <h3 style="height:30px;" class="panel-title"><span id="yanip-sonen"><i class="fa fa-exclamation" aria-hidden="true"></i> Lütfen Yönetici Bilgilerinizi Değiştirin</span></h3>
                                </div>
                                <div class="panel-body">
                                    <p>Kötü niyetli kişilerin admin panelinize erişerek sitenize zarar vermemesi için, standart olarak tanımlı gelen admin e-posta ve parola bilgilerinizi değiştirin.</p>
                                </div>
                            </div>
                        <?php } ?>
                        ...
                        <form role="form" class="form-horizontal" id="hesap_bilgi_form" method="POST" action="ajax.php?p=hesap_bilgileri" onsubmit="return false;" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="adi" name="adi" value="<?= sanitizeInput($hesap->adi); ?>" placeholder="Buraya sayfamın sol üstünde logo nun yanında gözükecek İsmi yazınız - Firma Adı veya Adınız">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="email" name="email" value="<?= sanitizeInput($hesap->email); ?>" placeholder="Sitede kullandığınız E-postanızı Yazın">
                                </div>
                            </div>
                            <div class="form-group">
