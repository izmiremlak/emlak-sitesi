...
if ($hesap->tipi != 2) {
    if ($sil) {
        $query = $db->prepare("DELETE FROM sayfalar WHERE site_id_555=888 AND id=:id");
                    ...
                    <div class="panel panel-default m-t-20">
                        <div class="panel-body">
                            <table class="table table-hover mails datatable">
                                ...
                                <tbody>
                                    <?php
                                    $sorgu = $db->query("SELECT * FROM sayfalar WHERE site_id_555=888 AND tipi=2 AND dil='".sanitizeInput($dil)."' ORDER BY id DESC LIMIT 0,500");
