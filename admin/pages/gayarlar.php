                                    ...
                                    <div class="panel-body" style="height:150px;">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <br />
                                                <a target="_blank" href="../watermark.png"><img style="background:#333;float:left;margin-right:5px;" src="../watermark.png" id="watermark_src" height="50" /></a><span style="font-size:14px;">Watermark dosyası ".png" uzantılı olmalıdır.</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div id="digerayarlar" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                        <div style="padding:20px;">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-control" name="default_dil" id="default_dil">
                                                        ...
                                                        <?php
                                                        $dilsg = $db->query("SELECT * FROM diller_19541956 ORDER BY id ASC");
                                                    ...
                                                    <span style="font-size:14px;">Site ilk açılışta görüntülenecek dil. (Otomatik seçilirse, ziyaretçi lokasyonuna göre uygun olan dil otomatik olarak seçilir.)</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="yemails" value="<?=$dayarlar->yemails;?>" placeholder="Birden fazla girmek için virgül ile ayrınız.">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="yphones" value="<?=$dayarlar->yphones;?>" placeholder="Birden fazla girmek için virgül ile ayrınız.">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <label style="float:left;margin-right:10px;" for="permalink_check" class="stm-checkbox-label"></label><span style="margin-left:10px;font-size:14px;margin-top:5px;">(Seo url ayarıdır. Örnek: siteadi.com/seo-url)</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <span style="margin-left:10px;font-size:14px;margin-top:5px;">(Anasayfada bulunan slider'in üzerindeki arama kısmıdır. İsteğe bağlı pasif edebilirsiniz.)</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <span style="margin-left:10px;font-size:14px;margin-top:5px;">(Aktif edildiğinde ilan görsellerine yükleyeceğiniz watermark görseli basılmaktadır.)</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="checkbox checkbox-success">
                                                        ...
                                                        <label for="site_ssl_check"><STRONG>Aktif</STRONG></label> <span style="font-size:14px;"> (Sitenizi Https üzerinden çalıştıracaksanız bu seçeneği aktif edin.)</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="checkbox checkbox-success">
                                                        ...
                                                        <label for="site_www_check"><STRONG>Aktif</STRONG></label> <span style="font-size:14px;">(Sitenizin başına otomatik www. eklenmesini isterseniz aktif edin.)</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="checkbox checkbox-success">
                                                        ...
                                                        <label for="uyelik_check"><STRONG>Aktif</STRONG></label>  <span style="font-size:14px;">(Ziyaretçileriniz hesap oluşturarak ilan ekleyebilir. Pasif etmek isterseniz bu seçeneği kaldırın.)</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="checkbox checkbox-success">
                                                        ...
                                                        <label for="tcnod_check"><STRONG>Aktif</STRONG></label> <span style="font-size:14px;">(Üyelik esnasında bireysel üyelerden geçerli bir T.C.K.N. bilgisi istenir.)</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="checkbox checkbox-success">
                                                        ...
                                                        <label for="sms_aktivasyon_check"><STRONG>Aktif</STRONG></label> <span style="font-size:14px;">(Üyelik esnasında mobil onay istenir. SMS paketinizin olduğundan emin olun.)</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="checkbox checkbox-success">
                                                        ...
                                                        <label for="anlik_sohbet_check"><STRONG>Aktif</STRONG></label> <span style="font-size:14px;">(Üyeleriniz kendi aralarında anlık olarak mesajlaşabilir.)</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="checkbox checkbox-success">
                                                        <input id="dopingler_19541956_check" type="checkbox" name="dopingler_19541956" value="1" <?=($gayarlar->dopingler_19541956 == 1) ? 'checked' : ''; ?>>	
                                                    </div>
                                                 </div>
                                               </div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <div class="checkbox checkbox-success">
            ...
            <label for="reklamlar_check"><STRONG>Aktif</STRONG></label>
            <span style="font-size:14px;">(Belirli alanlarda reklam yayını yapmak istiyorsanız aktif ediniz.)</span>
        </div>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <div class="checkbox checkbox-success">
            ...
            <label for="doviz_check"><STRONG>Aktif</STRONG></label>
            <span style="font-size:14px;">(İlan detayında doviz kuru çıkar.)</span>
        </div>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <div class="checkbox checkbox-success">
            ...
            <label for="kredih_check"><STRONG>Aktif</STRONG></label>
            <span style="font-size:14px;">(İlan detayında Kredi Hesaplama çıkar.)</span>
        </div>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <div class="cp2 input-group colorpicker-component">
            <input name="renk1" type="text" value="<?=$gayarlar->renk1;?>" class="form-control" />
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <div class="cp2 input-group colorpicker-component">
            <input name="renk2" type="text" value="<?=$gayarlar->renk2;?>" class="form-control" />
            <span class="input-group-addon"><i></i></span>
        </div>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <?php
        $sql = $db->query("SELECT * FROM diller_19541956 ORDER BY sira ASC");
        while($row = $sql->fetch(PDO::FETCH_OBJ)) {
            $oneki = $row->kisa_adi;
            $onekiup = strtoupper($oneki);
        ?>
        <span style="float: left;margin-top: 7px;"> <strong>(<?=$onekiup;?>)</strong> <a href="<?=SITE_URL;?>sitemap.xml?dil=<?=$oneki;?>" target="_blank"> <?=SITE_URL;?>sitemap.xml?dil=<?=$oneki;?></a></span>
        <?php } ?>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-9">
        <button class="btn btn-danger waves-effect waves-light" type="button" onclick="ajaxHere('ajax.php?p=ban_list_temizle','hidden_result');"><i class="fa fa-trash"></i> Temizle</button>
        <span style="font-size:14px;">(Üyelik esnasında çok sayıda hatalı denemeler yaparak engellenen datayı temizleyebilirsiniz.)</span>
...
<div class="form-group" style="display:none">
    ...
    <div class="col-md-4">
        <input type="text" class="form-control" name="urun_brosur_link" value="<?=$dayarlar->urun_brosur_link;?>" />
    </div>
</div>
</div>
</div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                <select class="form-control" name="foot_sayfa1">
                    ...
                    <?php
                    $sql = $db->query("SELECT * FROM sayfalar WHERE site_id_555=888 AND dil='".$dil."' ORDER BY id DESC");
                    while($row = $sql->fetch(PDO::FETCH_OBJ)){
                    ?><option value="<?=$row->id;?>" <?=($dayarlar->foot_sayfa1 == $row->id) ? 'selected' : ''; ?>><?=$row->baslik;?></option><?php
                    }
                    ?>
                </select>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                <select class="form-control" name="foot_sayfa2">
                    ...
                    $sql = $db->query("SELECT * FROM sayfalar WHERE site_id_555=888 AND dil='".$dil."' ORDER BY id DESC");
                    while($row = $sql->fetch(PDO::FETCH_OBJ)){
                    ?><option value="<?=$row->id;?>" <?=($dayarlar->foot_sayfa2 == $row->id) ? 'selected' : ''; ?>><?=$row->baslik;?></option><?php
                    }
                    ?>
                </select>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                <select class="form-control" name="foot_sayfa3">
                    ...
                    $sql = $db->query("SELECT * FROM sayfalar WHERE site_id_555=888 AND dil='".$dil."' ORDER BY id DESC");
                    while($row = $sql->fetch(PDO::FETCH_OBJ)){
                    ?><option value="<?=$row->id;?>" <?=($dayarlar->foot_sayfa3 == $row->id) ? 'selected' : ''; ?>><?=$row->baslik;?></option><?php
                    }
                    ?>
                </select>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                <select class="form-control" name="foot_sayfa4">
                    ...
                    $sql = $db->query("SELECT * FROM sayfalar WHERE site_id_555=888 AND dil='".$dil."' ORDER BY id DESC");
                    while($row = $sql->fetch(PDO::FETCH_OBJ)){
                    ?><option value="<?=$row->id;?>" <?=($dayarlar->foot_sayfa4 == $row->id) ? 'selected' : ''; ?>><?=$row->baslik;?></option><?php
                    }
                    ?>
                </select>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                <select class="form-control" name="foot_sayfa5">
                    ...
                    $sql = $db->query("SELECT * FROM sayfalar WHERE site_id_555=888 AND dil='".$dil."' ORDER BY id DESC");
                    while($row = $sql->fetch(PDO::FETCH_OBJ)){
                    ?><option value="<?=$row->id;?>" <?=($dayarlar->foot_sayfa5 == $row->id) ? 'selected' : ''; ?>><?=$row->baslik;?></option><?php
                    }
                    ?>
                </select>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                <select class="form-control" name="foot_sayfa6">
                    ...
                    $sql = $db->query("SELECT * FROM sayfalar WHERE site_id_555=888 AND dil='".$dil."' ORDER BY id DESC");
                    while($row = $sql->fetch(PDO::FETCH_OBJ)){
                    ?><option value="<?=$row->id;?>" <?=($dayarlar->foot_sayfa6 == $row->id) ? 'selected' : ''; ?>><?=$row->baslik;?></option><?php
                    }
                    ?>
                </select>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                <select class="form-control" name="foot_sayfa7">
                    ...
                    $sql = $db->query("SELECT * FROM sayfalar WHERE site_id_555=888 AND dil='".$dil."' ORDER BY id DESC");
                    while($row = $sql->fetch(PDO::FETCH_OBJ)){
                    ?><option value="<?=$row->id;?>" <?=($dayarlar->foot_sayfa7 == $row->id) ? 'selected' : ''; ?>><?=$row->baslik;?></option><?php
                    }
                    ?>
                </select>
            </div>
