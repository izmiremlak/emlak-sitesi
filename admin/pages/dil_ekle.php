                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="panel panel-fill panel-danger">
                            ...
                            <div class="panel-body">
                                <p>Yeni dil ekleme/düzenleme ve multilanguage kullanımı nasıl olur detaylı bilgi almak için <strong><a style="color:white;cursor:pointer;" data-toggle="modal" data-target=".bs-example-modal-lg">buraya</a></strong> tıklayabilirsiniz.</p>
                            </div>
                        </div>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p>Çoğu yazılımlarımızda standart olarak gelen&nbsp;<span style="font-weight: bold;">Sınırsız Çoklu Dil (Multi Language)</span> sisteminin kullanımı ve <span style="font-weight: bold;">diğer dillerden içerik kopyalama</span> hakkında bilgi almak için bizimle iletişime geçebilirsiniz.</p>
                                    </div>
                                </div><!-- /.modal-content -->
                            </div><!-- /.modal-dialog -->
                        </div><!-- /.modal -->
