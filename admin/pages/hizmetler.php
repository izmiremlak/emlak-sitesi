                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="btn-toolbar" role="toolbar">
                                        ...
                                        <div class="btn-group">
										<button type="button" class="btn btn-info waves-effect waves-light w-lg m-b-5" onclick="window.location.href='index.php?p=hizmet_ekle';"> <i class="fa fa-plus"></i> Yeni Ekle</button>
										
										</div>
										
										<div class="btn-group">
										<button type="button" class="btn btn-info waves-effect waves-light w-lg m-b-5" onclick="window.location.href='index.php?p=hizmet_kategoriler';"> <i class="fa fa-table"></i> Kategoriler</button>
...
if($sil != ""){
$db->query("DELETE FROM sayfalar WHERE site_id_555=888 AND id=".$sil." ");
...
$id			= $gvn->rakam($id);
if($action == 'sil'){
$db->query("DELETE FROM sayfalar WHERE site_id_555=888 AND id=".$id);
}
} // FOREACH END
} // eğer varsa
...
?>
										...
										<tbody>
										<?php
										$sorgu		= $db->query("SELECT * FROM sayfalar WHERE site_id_555=888 AND tipi=3 AND dil='".$dil."' ORDER BY id DESC LIMIT 0,500");
										...
										<label for="checkbox<?=$row->id;?>"></label>
										 ...
										 <td><?=$row->baslik;?></td>
										 <td><?=($dayarlar->permalink == 'Evet') ? $row->url.'.html' : 'index.php?p=sayfa&id='.$row->id;?></td>
										 <td><?=$row->tarih;?></td>
										 <td>
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="index.php?p=hizmet_duzenle&id=<?=$row->id;?>">Düzenle</a></li>
                                            <li><a href="index.php?p=hizmetler&sil=<?=$row->id;?>">Sil</a></li>
                                        </ul>
                                    </div>
