...
$snc		= $db->prepare("SELECT * FROM upaketler_19541956 WHERE id=:ids");
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <form role="form" class="form-horizontal"  id="forms" method="POST" action="ajax.php?p=upaket_duzenle&id=<?=$snc->id;?>" onsubmit="return false;" enctype="multipart/form-data">
									...
									<div class="form-group">
											...
											<a href="index.php?p=uye_duzenle&id=<?=$uye->id;?>"><?=$name;?></a>
											</span>
                                        </div>
                                    </div>
									<?}?>
									...
									if($kgun>0){
									?><strong style="color:green"><i class="fa fa-clock-o"></i> <?=$kgun;?> gün kaldı.</strong><?
									}elseif($kgun == 0){
									?><strong style="color:orange"><i class="fa fa-clock-o"></i> Bugün sona eriyor.</strong><?
									}else{
									?><strong style="color:red"><i class="fa fa-clock-o"></i> Süresi Doldu.</strong><?
									}
									?>
											</span>
                                        </div>
									...
									<div class="form-group">
											...
											?><option <?=($snc->odeme_yontemi == $yontem) ? 'selected' : ''; ?>><?=$yontem;?></option><?
											}
											?>
											</select>
                                        </div>
									...
									<div class="col-sm-9">
									<input type="text" class="form-control" id="tutar" name="tutar" value="<?=$gvn->para_str($snc->tutar);?>" placeholder="">
									</div>
									</div>
									...
									<div class="col-sm-1">
									<input type="text" class="form-control" name="sure" value="<?=$snc->sure;?>" placeholder="">
									</div>
									<div class="col-sm-2">
									<select class="form-control" name="periyod">
									<?php
									foreach($periyod AS $k=>$v){
									?><option value="<?=$k;?>"<?=($snc->periyod == $k) ? " selected" : '';?>><?=$v;?></option><?
									}
									?>
									</select>
									</div>
									...
									<div class="col-sm-9">
									<input type="text" class="form-control" id="btarih" name="btarih" value="<?=($snc->btarih == '') ? '' : date("d.m.Y",strtotime($snc->btarih));?>" placeholder="Örn:25.05.2017">
									</div>
									</div>
