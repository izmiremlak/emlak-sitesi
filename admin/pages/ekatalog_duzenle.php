                        ...
                        <form role="form" class="form-horizontal" id="forms" method="POST" action="ajax.php?p=ekatalog_duzenle&id=<?=$snc->id;?>" onsubmit="return false;" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <?= ($snc->resim != '') ? '<img src="../uploads/thumb/'.$snc->resim.'" id="resim_src" width="150" />' : ''; ?>
                                    <p style="margin-left:10px;font-size:13px;margin-top:5px;">Yükleyeceğiniz görselin boyutları <?=$gorsel_boyutlari['ekatalog']['thumb_x']; ?> x <?=$gorsel_boyutlari['ekatalog']['thumb_y']; ?> olmalıdır.</p>
                                </div>
                            </div>
                            <div class="form-group">
