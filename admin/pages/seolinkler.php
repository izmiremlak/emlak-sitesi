                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" class="form-horizontal" id="forms" method="POST" action="ajax.php?p=seolinkler" onsubmit="return false;" enctype="multipart/form-data">
                            <div id="lokasyonlar_list1">
                                ...
                                while ($row = $sql->fetch()) {
                                ?>
                                <input type="text" class="form-control" name="baslik[]" value="<?= sanitizeInput($row->adi); ?>" placeholder="Başlık" style="float:left;width:19%;margin-right:5px;margin-bottom:5px;">
                                <input type="text" class="form-control" name="link[]" value="<?= sanitizeInput($row->website); ?>" placeholder="URL Adresi" style="float:left;width:19%;margin-right:5px;margin-bottom:5px;">
                                <input type="text" class="form-control" name="sira[]" value="<?= sanitizeInput($row->sira); ?>" placeholder="Sıra" style="float:left;width:5%;margin-right:5px;margin-bottom:5px;">
