...
<div class="btn-group">
    <button type="button" class="btn btn-info waves-effect waves-light w-lg m-b-5" onclick="window.location.href='index.php?p=ilan_ekle&acid=<?=htmlspecialchars($snc->id, ENT_QUOTES, 'UTF-8');?>';"> <i class="fa fa-plus"></i> Yeni Ekle</button>
</div>
