...
$avatar		= ($snc->avatar == '' ) ? 'https://www.turkiyeemlaksitesi.com.tr/uploads/default-avatar.png' : 'https://www.turkiyeemlaksitesi.com.tr/uploads/thumb/'.$snc->avatar;
...
$kurumsal->execute(array($snc->kid));
...
<div class="row">
                        <div class="col-lg-12">
                            <ul class="nav nav-tabs tabs">
                                ...
                                <span class="hidden-xs">Üye Bilgileri</span></a>
                                </li>
								
                                <li class="tab">
                                <a href="#tab2" data-toggle="tab" aria-expanded="false">
                                <span class="hidden-xs">İlanları</span></a>
                                </li>
								
								<?if($snc->turu == 1){?><li class="tab">
                                <a href="#tab3" data-toggle="tab" aria-expanded="false">
                                <span class="hidden-xs">Danışmanları</span></a>
                                </li><?}?>
								
								<?if($snc->turu == 0 || $snc->turu == 1){?><li class="tab">
                                <a href="#tab4" data-toggle="tab" aria-expanded="false">
                                <span class="hidden-xs">Mağaza Paketleri</span></a>
                                </li><?}?>
								
								<li class="tab">
                                <a href="#tab5" data-toggle="tab" aria-expanded="false">
                                <span class="hidden-xs">Dopingleri</span></a>
                                </li>
								
								<li class="<?=($goto == 'mesajlar') ? "active " : '';?>tab">
                                <a href="#tab6" data-toggle="tab" aria-expanded="false">
                                <span class="hidden-xs">Mesajları</span></a>
                                </li>
...
<div style="padding:20px;">
									...
									<label for="ilan_aktifet_check"><STRONG>Aktif</STRONG></label> <span style="font-size:14px;">(Eklenen ilanlar otomatik onaylanarak yayınlanır.)</span>
										...
										<div class="form-group">
											...
											<a href="index.php?p=uye_duzenle&id=<?=$kurumsal->id;?>"><?=($kurumsal->unvan == '') ? $kurumsal->adi.' '.$kurumsal->soyadi : $kurumsal->unvan;?></a>
											</span>
                                        </div>
                                        </div>
										<?}?>
...
<tr id="row_<?=$row->id;?>">
<td><?=$row->baslik;?></td>
<td><strong><?=$fiyat.' '.$row->pbirim;?></strong></td>
<td>
<?php
if($row->durum == 0){
?><span style="color:red;font-weight:bold;">Onay Bekliyor</span><?
}elseif($row->durum == 1){
?><span style="color:green;font-weight:bold;">Yayında</span><?
}elseif($row->durum == 2){
?><span style="color:green;font-weight:bold;">Reddedildi</span><?
}elseif($row->durum == 3){
?><span style="color:orange;font-weight:bold;">Pasif</span><?
}
?>
</td>
...
<? } ?> 
							...
							<table class="table table-hover mails datatable">
										...
										<td style="display:none" class="mail-select"><?=$i;?></td>
										 <td><b><a href="index.php?p=uye_duzenle&id=<?=$row->id;?>"><?=$row->adi.' '.$row->soyadi;?></a></b></td>
										 <td><?=$row->email;?></td>
										 <td><?=$row->telefon;?></td>
...
$miletiler->execute(array('mesaj_id' => $mesaj_id,'bid' => $bid));
