                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <form role="form" class="form-horizontal"  id="forms" method="POST" action="ajax.php?p=video_galeri_duzenle&id=<?=$snc->id;?>" onsubmit="return false;" enctype="multipart/form-data">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-sm-9">
											<input type="text" class="form-control" id="youtube" name="youtube" value="<?=$snc->youtube;?>" placeholder="Örn: https://www.youtube.com/watch?v=EO_vhggvUCE">
                                        </div>
                                        </div> 
										...
										<div class="form-group">
											...
											<img src="<?=$snc->resim;?>" width="250" id="resim_src">
