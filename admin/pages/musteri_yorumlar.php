                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="btn-toolbar" role="toolbar">
                                        ...
                                        <div class="btn-group">
										<button type="button" class="btn btn-info waves-effect waves-light w-lg m-b-5" onclick="window.location.href='index.php?p=musteri_yorum_ekle';"> <i class="fa fa-plus"></i> Yeni Ekle</button>
...
if($sil != ""){
$db->query("DELETE FROM musteri_yorumlar WHERE id=".$sil." ");
...
$id			= $gvn->rakam($id);
if($action == 'sil'){
$db->query("DELETE FROM musteri_yorumlar WHERE id=".$id);
}
} // FOREACH END
} // eğer varsa
...
?>
										...
										<tbody>
										<?php
										$sorgu		= $db->query("SELECT * FROM musteri_yorumlar WHERE dil='".$dil."' ORDER BY id DESC LIMIT 0,500");
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="index.php?p=musteri_yorum_duzenle&id=<?=$row->id;?>">Düzenle</a></li>
                                            <li><a href="index.php?p=musteri_yorumlar&sil=<?=$row->id;?>">Sil</a></li>
                                        </ul>
                                    </div>
