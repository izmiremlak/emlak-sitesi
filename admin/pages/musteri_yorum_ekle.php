                        ...
                        <form role="form" class="form-horizontal" id="forms" method="POST" action="ajax.php?p=musteri_yorum_ekle" onsubmit="return false;" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <p style="margin-left:10px;font-size:13px;margin-top:5px;">Yükleyeceğiniz görselin boyutları <?= sanitizeInput((string)$gorsel_boyutlari['musteri_yorumlar']['thumb_x']); ?> x <?= sanitizeInput((string)$gorsel_boyutlari['musteri_yorumlar']['thumb_y']); ?> px olmalıdır.</p>
                                </div>
                            </div>
                            <div class="form-group">
