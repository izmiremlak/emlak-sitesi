                            ...
                            <div class="portfolioContainer">
                                ...
                                <div class="col-sm-6 col-lg-3 col-md-4 webdesign illustrator" id="foto_<?=$row->id;?>">
                                    <div class="gal-detail thumb">
                                        <a href="/var/www/vhosts/turkiyeemlaksitesi.com.tr/turkiyeemlaksitesi.com.tr/uploads/<?=$row->resim;?>" class="image-popup">
                                            <img src="/var/www/vhosts/turkiyeemlaksitesi.com.tr/turkiyeemlaksitesi.com.tr/uploads/<?=$row->resim;?>" class="thumb-img" alt="<?=$row->baslik;?>">
                                        </a>
                                        <h4 align="center">
                                            <a href="javascript:;" onclick="ajaxHere('ajax.php?p=galeri_foto_sil&id=<?=$row->id;?>','silsnc');">
