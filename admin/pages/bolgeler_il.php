...
<head>
    ...
    <title>İl: <?= htmlspecialchars($snc->il_adi, ENT_QUOTES, 'UTF-8'); ?></title>
...
<body>
    <div class="content">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">İl: <?= htmlspecialchars($snc->il_adi, ENT_QUOTES, 'UTF-8'); ?></h4>
                </div>
            </div>
            <div id="VeriEkle" class="modal fade bs-example-modal-lg" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content" style="width:60%; margin-left:auto;margin-right:auto;">
                        ...
                        <form role="form" class="form-horizontal" id="forms" method="POST" action="ajax.php?p=bolgeler_ilce_ekle&il_id=<?= htmlspecialchars($snc->id, ENT_QUOTES, 'UTF-8'); ?>" onsubmit="return false;" enctype="multipart/form-data">
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="adi" class="col-sm-1 control-label">Adı</label>
                                    <div class="col-sm-11">
                                        <input type="text" class="form-control" id="adi" name="adi" value="<?= htmlspecialchars($adi ?? '', ENT_QUOTES, 'UTF-8'); ?>" placeholder="">
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-8">
                            ...
                            <table class="table table-hover mails datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($row->ilce_adi, ENT_QUOTES, 'UTF-8'); ?></td>
                                        <td><?= htmlspecialchars($topsemt, ENT_QUOTES, 'UTF-8'); ?></td>
                                        ...
                                        <td>
                                            <div class="btn-group dropdown">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a href="index.php?p=bolgeler_ilce&id=<?= htmlspecialchars($row->id, ENT_QUOTES, 'UTF-8'); ?>">Düzenle</a></li>
                                                    <li><a href="index.php?p=bolgeler_il&id=<?= htmlspecialchars($snc->id, ENT_QUOTES, 'UTF-8'); ?>&sil=<?= htmlspecialchars($row->id, ENT_QUOTES, 'UTF-8'); ?>">Sil</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <form role="form" class="form-horizontal" id="formss" method="POST" action="ajax.php?p=bolgeler_il&id=<?= htmlspecialchars($snc->id, ENT_QUOTES, 'UTF-8'); ?>" onsubmit="return false;" enctype="multipart/form-data">
                        <div id="form_statuss"></div>
                        <div class="form-group">
                            <label for="il_adi" class="col-sm-3 control-label">İl Adı</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="il_adi" name="il_adi" value="<?= htmlspecialchars($snc->il_adi, ENT_QUOTES, 'UTF-8'); ?>" placeholder="">
                            </div>
                        </div>
                        <div align="right">
