...
// Silme işlemi
if ($hesap->tipi != 2 && $sil) {
    $stmt = $db->prepare("DELETE FROM sayfalar WHERE site_id_555 = 888 AND id = :id");
    $stmt->execute(['id' => $sil]);
                    ...
                    <div class="panel panel-default m-t-20">
                        <div class="panel-body">
                            <table class="table table-hover mails datatable">
                                ...
                                <tbody>
                                    <?php
                                    $sorgu = $db->query("SELECT * FROM sayfalar WHERE site_id_555 = 888 AND tipi = 5 AND dil = :dil ORDER BY id DESC LIMIT 0, 500", ['dil' => $dil]);
