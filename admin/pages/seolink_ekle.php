                        ...
                        <form role="form" class="form-horizontal" id="forms" method="POST" action="ajax.php?p=seolink_ekle" onsubmit="return false;" enctype="multipart/form-data">
                            ...
                            <div class="form-group" style="display:none">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <p style="margin-left:10px;font-size:13px;margin-top:5px;">Yükleyeceğiniz görselin boyutları <?= sanitizeInput((string)$gorsel_boyutlari['referanslar']['thumb_x']); ?> x <?= sanitizeInput((string)$gorsel_boyutlari['referanslar']['thumb_y']); ?> olmalıdır.</p>
                                </div>
                            </div>
                            <div align="right">
