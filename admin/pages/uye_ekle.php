                            ...
                            <div class="form-group kurumsal">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" id="ulke_id" name="ulke_id" onchange="yazdir();ajaxHere('ajax.php?p=il_getir&ulke_id='+this.options[this.selectedIndex].value,'il');">
                                        ...
                                        ?><option value="<?=htmlspecialchars($row->id, ENT_QUOTES, 'UTF-8');?>" <?=($snc->ulke_id == $row->id) ? 'selected' : '';?>><?=htmlspecialchars($row->ulke_adi, ENT_QUOTES, 'UTF-8');?></option><?php
                                        }
                                        ?>
                                    </select>
                                </div>
    ...
    <div class="col-sm-9">
        <select class="form-control" id="il" name="il" onchange="ajaxHere('ajax.php?p=ilce_getir&il_id='+this.options[this.selectedIndex].value,'ilce'),$('#semt').html(''),yazdir();">
            ...
            while ($row = $sql->fetch(PDO::FETCH_OBJ)) {
                ...
                ?><option value="<?=htmlspecialchars($row->id, ENT_QUOTES, 'UTF-8');?>" <?=($row->id == $snc->il_id) ? 'selected' : '';?>><?=htmlspecialchars($row->il_adi, ENT_QUOTES, 'UTF-8');?></option><?php
            }
            ?>
        </select>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <input type="text" class="form-control" id="adres" name="adres" value="<?=htmlspecialchars($snc->adres, ENT_QUOTES, 'UTF-8');?>" placeholder="Gerekli ise doldurunuz.">
    </div>
</div>
