                        ...
                        <div class="panel-body">
                            ...
                            <form role="form" class="form-horizontal" id="forms" method="POST" action="ajax.php?p=belge_duzenle&id=<?= htmlspecialchars($snc->id, ENT_QUOTES, 'UTF-8'); ?>" onsubmit="return false;" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="baslik" name="baslik" value="<?= htmlspecialchars($snc->baslik, ENT_QUOTES, 'UTF-8'); ?>" placeholder="Slayt Başlığı Yazın">
                                    </div>
                                </div>
                                <!-- Sıra Nosu Alanı -->
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="sira" name="sira" value="<?= htmlspecialchars($snc->sira, ENT_QUOTES, 'UTF-8'); ?>" placeholder="Slayt Sıra Nosu Yazın">
                                    </div>
                                </div>
                                <!-- Dosya Alanı -->
                                <div class="form-group">
