...
<div class="row">
                        <div class="col-lg-12">
                            <ul class="nav nav-tabs tabs">
                                ...
                                <span class="hidden-xs">Proje Bilgisi</span></a></li>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <form role="form" class="form-horizontal"  id="forms" method="POST" action="ajax.php?p=proje_duzenle&id=<?=$snc->id;?>" onsubmit="return false;" enctype="multipart/form-data">
										...
										<div class="form-group" style="display:none">
                                            ...
                                            <div class="col-sm-9">
											<textarea rows="5" class="form-control" id="kisa_icerik" name="kisa_icerik"><?=$snc->kisa_icerik;?></textarea>
                                        </div>
                                        </div>
                                    ...
                                    <div class="radio radio-inline">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-sm-9">
											<input type="text" class="form-control" id="maps" name="maps" value="<?=$snc->maps;?>" >
                                        </div>
                                        </div>
...
<?php
$sql		= $db->query("SELECT * FROM galeri_foto WHERE site_id_555=999 AND sayfa_id=".$snc->id." AND dil='".$dil."' ORDER BY id DESC");
while($row	= $sql->fetch(PDO::FETCH_OBJ)){
?>
...
<? } ?>
	...
	<script>
	var gurl	= 'ajax.php?p=proje_duzenle&id=<?=$snc->id;?>&galeri=1'; 
	</script>
