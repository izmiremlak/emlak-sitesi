                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <form role="form" class="form-horizontal" id="forms" method="POST" action="ajax.php?p=proje_duzenle&id=<?= sanitizeInput((string)$snc->id); ?>" onsubmit="return false;" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <p style="margin-left:10px;font-size:13px;margin-top:5px;">Yükleyeceğiniz görselin boyutları <?= sanitizeInput((string)$gorsel_boyutlari['projeler']['resim1']['thumb_x']); ?> x <?= sanitizeInput((string)$gorsel_boyutlari['projeler']['resim1']['thumb_y']); ?> px olmalıdır.</p>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <p style="margin-left:10px;font-size:13px;margin-top:5px;">Yükleyeceğiniz görselin boyutları <?= sanitizeInput((string)$gorsel_boyutlari['projeler']['resim2']['orjin_x']); ?> x <?= sanitizeInput((string)$gorsel_boyutlari['projeler']['resim2']['orjin_y']); ?> px olmalıdır.</p>
                                                </div>
                                            </div>
                                            <div class="form-group">
                    ...
                    <div class="tab-pane" id="tab2">
                        ...
                        <div class="row port">
                            <div class="portfolioContainer">
                                <?php
                                $sql = $db->query("SELECT * FROM galeri_foto WHERE site_id_555=999 AND sayfa_id=" . sanitizeInput((string)$snc->id) . " AND dil='$dil' ORDER BY id DESC");
                                while ($row = $sql->fetch()) {
                                ?>
                                <div class="col-sm-6 col-lg-3 col-md-4 webdesign illustrator" id="foto_<?= sanitizeInput((string)$row->id); ?>">
                                    <div class="gal-detail thumb">
                                        ...
                                        <h4 align="center">
                                            <a href="javascript:;" onclick="ajaxHere('ajax.php?p=galeri_foto_sil&id=<?= sanitizeInput((string)$row->id); ?>', 'silsnc');"><button class="btn btn-icon waves-effect waves-light btn-danger m-b-5"><i class="fa fa-remove"></i></button></a>
                                        </h4>
                                    </div>
                                </div>
                                <?php
