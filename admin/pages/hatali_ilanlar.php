<?php
$db->query("UPDATE mail_19541956 SET durumb='1' WHERE tipi=1 AND durumb=0");
?>            <div class="content">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
...
<input type="hidden" name="action" value="" id="action_hidden">	
										...
										<tbody>
										<?php
										$sorgu		= $db->query("SELECT * FROM mail_19541956 WHERE tipi=1 ORDER BY durum ASC, id DESC LIMIT 0,500");
										...
										$ilan->execute(array($custom["ilan_id"]));
										if($ilan->rowCount()>0){
										...
										<label for="checkbox<?=$msg->id;?>"></label>
										 ...
										 <td><a href="index.php?p=uye_duzenle&id=<?=$custom["acid"];?>" target="_blank"><?=$msg->adsoyad;?></a></td>
...
<p>İlan: <a href="index.php?p=ilan_duzenle&id=<?=$ilan->id;?>" target="_blank"><strong><?=$baslik;?></strong></a></p>
<p><?=$msg->mesaj;?></p>
</div>
...
<button type="button" class="btn btn-danger" data-dismiss="modal">Kapat</button>
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            ...
                                            <li><a href="index.php?p=hatali_ilanlar&okundu=<?=$msg->id;?>">Okundu</a></li>
                                            <li><a href="index.php?p=hatali_ilanlar&sil=<?=$msg->id;?>">Sil</a></li>
                                        </ul>
                                    </div>
