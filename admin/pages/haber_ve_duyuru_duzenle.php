                        ...
                        <form role="form" class="form-horizontal" id="forms" method="POST" action="ajax.php?p=haber_ve_duyuru_duzenle&id=<?= sanitizeInput($snc->id); ?>" onsubmit="return false;" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <p style="margin-left:10px;font-size:13px;margin-top:5px;">Yükleyeceğiniz görselin boyutları <?= sanitizeInput($gorsel_boyutlari['haber_ve_duyurular']['resim1']['thumb_x']); ?> x <?= sanitizeInput($gorsel_boyutlari['haber_ve_duyurular']['resim1']['thumb_y']); ?> olmalıdır.</p>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <p style="margin-left:10px;font-size:13px;margin-top:5px;">Yükleyeceğiniz görselin boyutları <?= sanitizeInput($gorsel_boyutlari['haber_ve_duyurular']['resim2']['orjin_x']); ?> x <?= sanitizeInput($gorsel_boyutlari['haber_ve_duyurular']['resim2']['orjin_y']); ?> olmalıdır.</p>
                                </div>
                            </div>
                            <div class="form-group">
