                        ...
                        <form role="form" class="form-horizontal" id="forms" method="POST" action="ajax.php?p=yazi_duzenle&id=<?= sanitizeInput((string)$snc->id); ?>" onsubmit="return false;" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <p style="margin-left:10px;font-size:13px;margin-top:5px;">Yükleyeceğiniz görselin boyutları <?= sanitizeInput((string)$gorsel_boyutlari['yazilar']['resim1']['thumb_x']); ?> x <?= sanitizeInput((string)$gorsel_boyutlari['yazilar']['resim1']['thumb_y']); ?> olmalıdır.</p>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <p style="margin-left:10px;font-size:13px;margin-top:5px;">Yükleyeceğiniz görselin boyutları <?= sanitizeInput((string)$gorsel_boyutlari['yazilar']['resim2']['orjin_x']); ?> x <?= sanitizeInput((string)$gorsel_boyutlari['yazilar']['resim2']['orjin_y']); ?> olmalıdır.</p>
                                </div>
                            </div>
                            <div class="form-group">
