                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <form role="form" class="form-horizontal"  id="forms" method="POST" action="ajax.php?p=foto_slider_duzenle&id=<?=$snc->id;?>" onsubmit="return false;" enctype="multipart/form-data">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-sm-9">
											<input type="text" class="form-control" id="aciklama" name="aciklama" value="<?=$snc->aciklama;?>" placeholder="">
                                        </div>
                                        </div>
										...
										<div class="form-group">
                                            ...
                                            <div class="col-sm-9">
											<input type="file" class="form-control" id="resim" name="resim" value="" > <br />
											<img src="../uploads/thumb/<?=$snc->resim;?>" width="250" id="resim_src">
											<p style="margin-left:10px;font-size:13px;margin-top:5px;">Yükleyeceğiniz görselin boyutları <?=$gorsel_boyutlari['slider']['orjin_x']; ?> x <?=$gorsel_boyutlari['slider']['orjin_y']; ?> px olmalıdır.</p>
                                        </div>
                                        </div>
