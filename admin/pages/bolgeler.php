                                ...
                                <table class="table table-hover mails datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= htmlspecialchars($row->ulke_adi, ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td><?= htmlspecialchars($topil, ENT_QUOTES, 'UTF-8'); ?></td>
                                            ...
                                            <td>
                                                <div class="btn-group dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li><a href="index.php?p=bolgeler_ulke&id=<?= htmlspecialchars($row->id, ENT_QUOTES, 'UTF-8'); ?>">Düzenle</a></li>
                                                        <li><a href="index.php?p=bolgeler&sil=<?= htmlspecialchars($row->id, ENT_QUOTES, 'UTF-8'); ?>">Sil</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
