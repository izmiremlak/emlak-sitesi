                        ...
                        <div class="panel-group" id="accordion-test-2">
                            <div class="panel panel-pink panel-color">
                                ...
                                <div id="collapseOne-2" class="panel-collapse collapse" aria-expanded="true">
                                    <div class="panel-body">
                                        Sitenizin en alt(footer) kısmında yer alan bülten alanından eklenen GSM Numaralarını bu alanda görebilir ve Toplu SMS gönderebilirsiniz. Ayrıca, toplu SMS servisinin çalışabilmesi için "<b>Genel Ayarlar / SMS Ayarları</b>" sekmesinden gerekli yapılandırmaları yapmanız gerekmektedir. Ek olarak bu modülün çalışabilmesi için sitenizin SMS servis sağlayıcınızla entegre olması gerekmektedir.
                                    </div>
                                </div>
                            </div>
                        </div>
