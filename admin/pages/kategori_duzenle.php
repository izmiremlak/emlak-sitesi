                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <form role="form" class="form-horizontal"  id="forms" method="POST" action="ajax.php?p=kategori_duzenle&id=<?=$snc->id;?>" onsubmit="return false;" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<?php
											$kats		= $db->query("SELECT * FROM kategoriler_19541956 WHERE tipi=0 AND ustu=0 AND dil='".$dil."' ORDER BY sira ASC");
											while($kat	= $kats->fetch(PDO::FETCH_OBJ)){
											?>
											<option value="<?=$kat->id;?>" <?=($kat->id == $snc->ustu) ? 'selected' : ''; ?>><?=$kat->baslik;?></option>
											<?
											}
											?>
											</select>
										...
										<div class="form-group">
											...
											<p style="margin-left:10px;font-size:13px;margin-top:5px;">Yükleyeceğiniz görselin boyutları <?=$gorsel_boyutlari['kategoriler']['resim2']['orjin_x']; ?> x <?=$gorsel_boyutlari['kategoriler']['resim2']['orjin_y']; ?> px olmalıdır.</p>
                                        </div>
                                        </div>
