                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="btn-toolbar" role="toolbar">
                                        ...
                                        <div class="btn-group">
										<button type="button" class="btn btn-info waves-effect waves-light w-lg m-b-5" onclick="window.location.href='index.php?p=uyelikp_ekle';"> <i class="fa fa-plus"></i> Yeni Ekle</button>
										
										</div>
										
										<div class="btn-group">
										<button type="button" class="btn btn-info waves-effect waves-light w-lg m-b-5" onclick="window.location.href='index.php?p=uyelik_paketleri_ozel';"> <i class="fa fa-edit"></i> Özel Alanları Düzenle</button>
...
if($sil != ""){
$db->query("DELETE FROM uyelik_paketleri_19541956 WHERE id=".$sil." ");
...
$id			= $gvn->rakam($id);
if($action == 'sil'){
$db->query("DELETE FROM uyelik_paketleri_19541956 WHERE id=".$id);
}
} // FOREACH END
} // eğer varsa
...
?>
										...
										<tbody>
										<?php
										$sorgu		= $db->query("SELECT * FROM uyelik_paketleri_19541956 ORDER BY id DESC LIMIT 0,500");
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="index.php?p=uyelikp_duzenle&id=<?=$row->id;?>">Düzenle</a></li>
                                            <li><a href="index.php?p=uyelik_paketleri&sil=<?=$row->id;?>">Sil</a></li>
                                        </ul>
                                    </div>
