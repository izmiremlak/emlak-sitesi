                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="btn-toolbar" role="toolbar">
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-info waves-effect waves-light w-lg m-b-5" onclick="window.location.href='index.php?p=uyelik_paketleri_ozel';"> <i class="fa fa-edit"></i> Özel Alanlar</button>
                                </div>
                                <div class="btn-group">
                    ...
                    <div class="panel panel-default m-t-20">
                        <div class="panel-body">
                            ...
                            if ($hesap->tipi != 2) {
                                ...
                                if ($sil !== null) {
                                    $db->prepare("DELETE FROM uyelik_paketleri_19541956 WHERE id = ?")->execute([$sil]);
                                ...
                                if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                    ...
                                    if (count($idler) > 0) {
                                        foreach ($idler as $id) {
                                            ...
                                            if ($action === 'sil') {
                                                $db->prepare("DELETE FROM uyelik_paketleri_19541956 WHERE id = ?")->execute([$id]);
                                            }
                                        }
                                    }
