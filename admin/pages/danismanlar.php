...
?>
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($row->adsoyad, ENT_QUOTES, 'UTF-8'); ?></td>
                                        <td><?= htmlspecialchars($row->gsm, ENT_QUOTES, 'UTF-8'); ?></td>
                                        ...
                                        <td>
                                            <div class="btn-group dropdown">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a href="index.php?p=danisman_duzenle&id=<?= htmlspecialchars($row->id, ENT_QUOTES, 'UTF-8'); ?>">Düzenle</a></li>
                                                    <li><a href="index.php?p=danismanlar&sil=<?= htmlspecialchars($row->id, ENT_QUOTES, 'UTF-8'); ?>">Sil</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
