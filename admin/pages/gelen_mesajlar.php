                                            ...
                                            <div id="myModal<?=$msg->id;?>" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="index.php?p=mail_gonder&kime=<?= urlencode($msg->email); ?>&mesaj=<?= urlencode($mesaji); ?>" target="_blank"><button type="button" class="btn btn-success"> <i class="fa fa-paper-plane" aria-hidden="true"></i> Cevapla</button></a>
                                                            <button type="button" class="btn btn-danger" data-dismiss="modal">Kapat</button>
                                                        </div>
                                                    </div>
                                                </div>
