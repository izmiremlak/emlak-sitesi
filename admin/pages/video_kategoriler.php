                    ...
                    <div class="panel panel-default m-t-20">
                        <div class="panel-body">
                            ...
                            if ($hesap->tipi != 2) {
                                ...
                                if ($sil !== null) {
                                    $db->prepare("DELETE FROM kategoriler_19541956 WHERE id = ?")->execute([$sil]);
                                ...
                                if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                    ...
                                    if (count($idler) > 0) {
                                        foreach ($idler as $id) {
                                            ...
                                            if ($action === 'sil') {
                                                $db->prepare("DELETE FROM kategoriler_19541956 WHERE id = ?")->execute([$id]);
                                            }
                                        }
                                    }
                            ...
                            <table class="table table-hover mails datatable">
                                ...
                                <tbody>
                                    <?php
                                    $sorgu = $db->prepare("SELECT * FROM kategoriler_19541956 WHERE tipi = 2 AND dil = ? ORDER BY id DESC LIMIT 0, 500");
                                    $sorgu->execute([$dil]);
