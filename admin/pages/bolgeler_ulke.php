...
<head>
    ...
    <title>Ülke: <?= htmlspecialchars($snc->ulke_adi, ENT_QUOTES, 'UTF-8'); ?></title>
...
<body>
    <div class="content">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Ülke: <?= htmlspecialchars($snc->ulke_adi, ENT_QUOTES, 'UTF-8'); ?></h4>
                </div>
            </div>
            ...
            <div id="VeriEkle" class="modal fade bs-example-modal-lg" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content" style="width:60%; margin-left:auto;margin-right:auto;">
                        ...
                        <form role="form" class="form-horizontal" id="forms" method="POST" action="ajax.php?p=bolgeler_il_ekle&ulke_id=<?= htmlspecialchars($snc->id, ENT_QUOTES, 'UTF-8'); ?>" onsubmit="return false;" enctype="multipart/form-data">
...
?>
                            ...
                            <form role="form" class="form-horizontal" id="formss" method="POST" action="ajax.php?p=bolgeler_ulke&id=<?= htmlspecialchars($snc->id, ENT_QUOTES, 'UTF-8'); ?>" onsubmit="return false;" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="ulke_adi" class="col-sm-3 control-label">Ülke Adı</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="ulke_adi" name="ulke_adi" value="<?= htmlspecialchars($snc->ulke_adi, ENT_QUOTES, 'UTF-8'); ?>" placeholder="">
                                    </div>
                                </div>
                                <div align="right">
...
?>
                                        <tr>
                                            ...
                                            <td><?= htmlspecialchars($row->il_adi, ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td><?= htmlspecialchars($topilce, ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td>
                                                <div class="btn-group dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li><a href="index.php?p=bolgeler_il&id=<?= htmlspecialchars($row->id, ENT_QUOTES, 'UTF-8'); ?>">Düzenle</a></li>
                                                        <li><a href="index.php?p=bolgeler_ulke&id=<?= htmlspecialchars($snc->id, ENT_QUOTES, 'UTF-8'); ?>&sil=<?= htmlspecialchars($row->id, ENT_QUOTES, 'UTF-8'); ?>">Sil</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
