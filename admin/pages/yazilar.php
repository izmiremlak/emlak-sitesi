                    ...
                    <div class="panel panel-default m-t-20">
                        <div class="panel-body">
                            ...
                            if ($hesap->tipi != 2) {
                                ...
                                if ($sil !== null) {
                                    $db->prepare("DELETE FROM sayfalar WHERE site_id_555 = 888 AND id = ?")->execute([$sil]);
                                ...
                                if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                    ...
                                    if (count($idler) > 0) {
                                        foreach ($idler as $id) {
                                            ...
                                            if ($action === 'sil') {
                                                $db->prepare("DELETE FROM sayfalar WHERE site_id_555 = 888 AND id = ?")->execute([$id]);
                                            }
                                        }
                                    }
                            ...
                            <table class="table table-hover mails datatable">
                                ...
                                <tbody>
                                    <?php
                                    $sorgu = $db->prepare("SELECT * FROM sayfalar WHERE site_id_555 = 888 AND tipi = 1 AND dil = ? ORDER BY id DESC LIMIT 0, 500");
                                    $sorgu->execute([$dil]);
