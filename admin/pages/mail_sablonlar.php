                            ...
                            <table class="table table-hover mails datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-info waves-effect waves-light w-lg m-b-5" onclick="window.location.href='index.php?p=mail_sablon_duzenle&id=<?= sanitizeInput((string)$row->id); ?>';"> <i class="fa fa-edit"></i> Düzenle</button>
                                        </td>
                                    </tr>
                                    <?php
                                    }
