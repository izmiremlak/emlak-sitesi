...
if ($_POST) {
    ...
    if ($hesap->id != "" && $hesap->tipi != 0) {
        ...
        $updt = $db->prepare("UPDATE mail_sablonlar_19541956 SET adi=?, konu=?, konu2=?, icerik=?, icerik2=?, icerik3=?, icerik4=?, ubildirim=?, abildirim=?, sbildirim=?, ysbildirim=?, degiskenler=?, yemails=?, yphones=? WHERE id=?");
