...
if ($hesap->id !== "" && $hesap->tipi !== 0) {
    ...
    $stmt = $db->prepare("SELECT * FROM diller_19541956 WHERE id = :id");
    $stmt->execute(['id' => $id]);
    ...
    $deleteQueries = [
        "DELETE FROM ayarlar_19541956 WHERE dil = :dil",
        "DELETE FROM galeri_foto WHERE site_id_555 = 999 AND dil = :dil",
        "DELETE FROM kategoriler_19541956 WHERE dil = :dil",
        "DELETE FROM mail_sablonlar_19541956 WHERE dil = :dil",
        "DELETE FROM menuler_19541956 WHERE dil = :dil",
        "DELETE FROM referanslar_19541956 WHERE dil = :dil",
        "DELETE FROM sayfalar WHERE site_id_555 = 888 AND dil = :dil",
        "DELETE FROM slider_19541956 WHERE dil = :dil",
        "DELETE FROM subeler_bayiler_19541956 WHERE dil = :dil",
        "DELETE FROM sehirler_19541956 WHERE dil = :dil"
    ];
    ...
    try {
        ...
        $stmt = $db->prepare("DELETE FROM diller_19541956 WHERE id = :id");
        $stmt->execute(['id' => $id]);
