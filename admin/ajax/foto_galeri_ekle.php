...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($hesap->id !== "" && $hesap->tipi !== 0) {
        ...
        // Permalink kontrolü
        $stmt = $db->prepare("SELECT id FROM kategoriler_19541956 WHERE baslik = :baslik AND dil = :dil");
        ...
        try {
            $stmt = $db->prepare("INSERT INTO kategoriler_19541956 (dil, baslik, url, tarih, sira, tipi) VALUES (:dil, :baslik, :url, :tarih, :sira, :tipi)");
