...
if ($_POST) {
    ...
    if ($hesap->id != "" && $hesap->tipi != 0) {
        ...
        $sql = $db->prepare("INSERT INTO kategoriler_19541956 SET dil=:dil, baslik=:baslik, url=:url, resim=:resim, resim2=:resim2, icerik=:icerik, tarih=:tarih, title=:title, keywords=:keywords, description=:description, sira=:sira, ustus=:ustus");
        $sql->execute([
            'dil' => $dil,
            'baslik' => $baslik,
            'url' => $url,
