...
if ($hesap->id !== "" && $hesap->tipi !== 0) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        try {
            $stmt = $db->prepare("INSERT INTO subeler_bayiler_19541956 (turu, lokasyon, sira, adres, telefon, gsm, email, google_maps, dil) VALUES (:turu, :lokasyon, :sira, :adres, :telefon, :gsm, :email, :google_maps, :dil)");
            $stmt->execute([
                'turu' => '1',
                'lokasyon' => $lokasyon,
                'sira' => $sira,
