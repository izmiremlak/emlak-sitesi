...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($hesap->id !== "" && $hesap->tipi !== 0) {
        ...
        $stmt = $db->prepare("SELECT id FROM sayfalar WHERE site_id_555 = 000 AND tipi = 4 AND danisman_id = :danisman_id");
        ...
        try {
            ...
            $query = $db->prepare("UPDATE sayfalar SET danisman_id = :danisman_yeni_id WHERE site_id_555 = 000 AND danisman_id = :danisman_id");
            $query->execute([
