...
$ulke_id = ($ulke_id == 0) ? $db->query("SELECT id FROM ulkeler_19541956 ORDER BY id DESC LIMIT 1")->fetch(PDO::FETCH_OBJ)->id : $ulke_id;

// İlan numarasının benzersiz olup olmadığını kontrol et
$noKontrol = $db->prepare("SELECT ilan_no FROM sayfalar WHERE site_id_555 = 0 AND ilan_no = ?");
