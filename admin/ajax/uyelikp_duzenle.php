...
try{
$query				= $db->prepare("UPDATE uyelik_paketleri_19541956 SET baslik=?,sira=?,renk=?,gizle=?,aylik_ilan_limit=?,ilan_resim_limit=?,ilan_yayin_sure=?,ilan_yayin_periyod=?,danisman_limit=?,danisman_onecikar=?,danisman_onecikar_sure=?,danisman_onecikar_periyod=?,ucretler=? WHERE id=?");
$query->execute(array($baslik,$sira,$renk,$gizle,$aylik_ilan_limit,$ilan_resim_limit,$ilan_yayin_sure,$ilan_yayin_periyod,$danisman_limit,$danisman_onecikar,$danisman_onecikar_sure,$danisman_onecikar_periyod,$ucretler,$id));
