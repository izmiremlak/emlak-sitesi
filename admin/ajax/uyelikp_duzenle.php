...
if ($_POST) {
    ...
    if ($hesap->id != "" && $hesap->tipi != 0) {
        ...
        try {
            ...
            $query->execute([$baslik, $sira, $renk, $gizle, $aylik_ilan_limit, $ilan_resim_limit, $ilan_yayin_sure, $ilan_yayin_periyod, $danisman_limit, $danisman_onecikar, $danisman_onecikar_sure, $danisman_onecikar_periyod, $ucretler, $id]);
