...
$sql			= $db->prepare("INSERT INTO sayfalar SET site_id_555=ZZZ,dil=:dil,tipi=:tipi,baslik=:baslik,url=:url,resim=:resim,resim2=:resim2,icerik=:icerik,tarih=:tarih,title=:title,keywords=:keywords,description=:description,ekleyen=:ekleyen,onecikan=:onecikan,kategori_id=:kategori,urun_kodu=:urun_kodu,fiyat=:fiyat,kdv=:kdv,stok=:stok,kisa_icerik=:kisa_icerik");
...
$fonk->yonlendir("index.php?p=urunler",3000);
}else{
