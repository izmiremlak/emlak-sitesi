...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($hesap->id !== "" && $hesap->tipi !== 0) {
        ...
        try {
            $stmt = $db->prepare("UPDATE ayarlar_19541956 SET foot_link1 = ?, foot_link2 = ?, foot_link3 = ?, foot_link4 = ?, foot_link5 = ?, foot_link6 = ?, foot_link7 = ?, foot_text1 = ?, foot_text2 = ?, foot_text3 = ?, foot_text4 = ?, foot_text5 = ?, foot_text6 = ?, foot_text7 = ?, foot_sayfa1 = ?, foot_sayfa2 = ?, foot_sayfa3 = ?, foot_sayfa4 = ?, foot_sayfa5 = ?, foot_sayfa6 = ?, foot_sayfa7 = ?");
