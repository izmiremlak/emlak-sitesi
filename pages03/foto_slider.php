                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="btn-toolbar" role="toolbar">
                                        ...
                                        <div class="btn-group">
										<button type="button" class="btn btn-info waves-effect waves-light w-lg m-b-5" onclick="window.location.href='index.php?p=foto_slider_ekle';"> <i class="fa fa-plus"></i> Yeni Ekle</button>
...
if($sil != ""){
$db->query("DELETE FROM slider_19541956 WHERE id=".$sil." ");
...
$id			= $gvn->rakam($id);
if($action == 'sil'){
$db->query("DELETE FROM slider_19541956 WHERE id=".$id);
}
} // FOREACH END
} // eğer varsa
...
?>
										...
										<?php
										$i			= 0;
										$sorgu		= $db->query("SELECT * FROM slider_19541956 WHERE dil='".$dil."' ORDER BY id DESC LIMIT 0,500");
										...
										<label for="checkbox<?=$row->id;?>"></label>
										 ...
										 <td><?=($row->baslik == '') ? 'Slider '.$i : $row->baslik;?></td>
										 <td><?=$row->sira;?></td>
										 <td><?=$row->tarih;?></td>
										 <td>
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="index.php?p=foto_slider_duzenle&id=<?=$row->id;?>">Düzenle</a></li>
                                            <li><a href="index.php?p=foto_slider&sil=<?=$row->id;?>">Sil</a></li>
                                        </ul>
                                    </div>
