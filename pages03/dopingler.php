                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="btn-toolbar" role="toolbar">
                                        ...
                                        <div class="btn-group">
										<button type="button" onclick="window.location.href='index.php?p=doping_ayarlar';" class="btn btn-danger waves-effect waves-light"><i class="fa fa-cog"></i> Doping Özellik ve Ücretleri</button>
										</div>
