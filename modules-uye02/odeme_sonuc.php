...
$odeme	= 0;
$hata 	= "Ge?ersiz bir sipari?";
}

}else{
$hata 	= "Status not success : ".$sonuc['errorMessage'];
}
}else{
$hata 	= "Ge?ersiz bir custom girildi.";
}
