...
header("Location:uyelik-paketleri"); die();
}
...
<h4 class="uyepaneltitle"><?=dil("TX572");?></h4>
...
<a class="btn" href="javascript:;" onclick="ajaxHere('ajax.php?p=upaket_siparis&id=<?=$paket->id;?>&periyod=<?=$periyodu;?>&odeme=havale_eft','SipSonuc');"><?=dil("TX544");?> <i class="fa fa-angle-double-right" style="margin-right:0px;margin-left:15px;" aria-hidden="true"></i></a></div>
<div class="clear"></div>
<div id="SipSonuc"></div>
...
<div id="OdemeButon" style="text-align:center;margin-top:25px;"><a class="btn" href="javascript:;" onclick="ajaxHere('ajax.php?p=upaket_siparis&id=<?=$paket->id;?>&periyod=<?=$periyodu;?>&odeme=paypal','SipSonuc');"><i class="fa fa-check"></i> <?=dil("TX546");?></a></div>
...
<input type="hidden" name="periyod" value="<?=$periyodu;?>">
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><strong><?=$paket->baslik;?></strong>
	<br />
	<span><?=dil("TX594");?>: <strong><?=($paket->aylik_ilan_limit == 0) ? dil("TX622") : $paket->aylik_ilan_limit." ".dil("TX595");?></strong> <a href="#" class="tooltip-bottom" data-tooltip="<?=str_replace("[aylik_ilan_limit]",($paket->aylik_ilan_limit == 0) ? dil("TX622") : $paket->aylik_ilan_limit." ".dil("TX595"),dil("TX596"));?>"><i style="    margin-left: 7px;    font-size: 16px;" class="fa fa-question-circle-o" aria-hidden="true"></i></a></span>
<br />
<span><?=dil("TX587");?>: <strong><?=($paket->ilan_resim_limit == 0) ? dil("TX622") : $paket->ilan_resim_limit." ".dil("TX581");?></strong> <a href="#" class="tooltip-bottom" data-tooltip="<?=str_replace("[ilan_resim_limit]",($paket->ilan_resim_limit == 0) ? dil("TX622") : $paket->ilan_resim_limit." ".dil("TX581"),dil("TX597"));?>"><i style="    margin-left: 7px;    font-size: 16px;" class="fa fa-question-circle-o" aria-hidden="true"></i></a></span>
<br />
<span><?=dil("TX588");?>: <strong><?=($paket->ilan_yayin_sure ==0) ? dil("TX622") : $paket->ilan_yayin_sure." ".$periyod[$paket->ilan_yayin_periyod];?></strong>  <a href="#" class="tooltip-bottom" data-tooltip="<?=str_replace("[ilan_yayin|sure|periyod]",($paket->ilan_yayin_sure ==0) ? dil("TX622") : $paket->ilan_yayin_sure." ".$periyod[$paket->ilan_yayin_periyod],dil("TX599"));?>"><i style="    margin-left: 7px;    font-size: 16px;" class="fa fa-question-circle-o" aria-hidden="true"></i></a></span>
<br />

<? if($hesap->turu ==1){?>
<span><?=dil("TX600");?>: <strong><?=($paket->danisman_limit == 0) ? dil("TX622") : $paket->danisman_limit." ".dil("TX581");?></strong> <a href="#" class="tooltip-bottom" data-tooltip="<?=str_replace("[danisman_limit]",($paket->danisman_limit == 0) ? dil("TX622") : $paket->danisman_limit." ".dil("TX581"),dil("TX601"));?>"><i style="    margin-left: 7px;    font-size: 16px;" class="fa fa-question-circle-o" aria-hidden="true"></i></a></span>
...
<br />
<?if($paket->danisman_onecikar == 1){?>
<span><?=dil("TX605");?>: <strong><?=($paket->danisman_onecikar_sure==0) ? dil("TX622") : $paket->danisman_onecikar_sure." ".$periyod[$paket->danisman_onecikar_periyod];?> <?=dil("TX583");?></strong> <a href="#" class="tooltip-bottom" data-tooltip="<?=dil("TX606");?>"><i style="    margin-left: 7px;    font-size: 16px;" class="fa fa-question-circle-o" aria-hidden="true"></i></a></span>
<?}else{?>
<span style="line-height: 39px;">--</span>
<?}}?>
	</td>
	<td align="center">(<? echo ($secilen["sure"] == 0 || $secilen["sure"] == 1) ? '' : $secilen["sure"]." "; echo $periyod[$secilen["periyod"]];?>)<br><strong><?=$gvn->para_str($secilen["tutar"]);?> <?=dil("UYELIKP_PBIRIMI");?></strong></td>
  </tr>
  
</table>

<H4 style="float:right;margin-top:25px;margin-bottom:25px;" id="ToplamOdenecek"><?=dil("TX523");?>: <strong><font id="toplam_tutar"><?=$gvn->para_str($secilen["tutar"]);?></font> <?=dil("UYELIKP_PBIRIMI");?></strong></H4>
