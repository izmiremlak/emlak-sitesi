<?php
// Üyelik türlerini dil dosyasından alıp diziye çeviriyoruz
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form role="form" class="form-horizontal" id="forms" method="POST" action="ajax.php?p=uye_ekle" onsubmit="return false;" enctype="multipart/form-data">
                            ...
                            <div class="form-group danisman">
                                ...
                                <div class="col-sm-9">
                                    <select name="kid" class="form-control">
                                        ...
                                        <?php
                                        // Kurumsal firmaları veritabanından çekiyoruz
                                        $smt = $db->query("SELECT id, unvan, concat_ws(' ', adi, soyadi) AS adsoyad FROM hesaplar WHERE site_id_555=999 AND turu=1 ORDER BY id DESC")->fetchAll(PDO::FETCH_OBJ);
                                        foreach ($smt as $row) {
                                            ?><option value="<?= $row->id; ?>"><?= ($row->unvan == '') ? $row->adsoyad : $row->unvan . " (" . $row->adsoyad . ") "; ?></option><?php
                                        }
                                        ?>
                                    </select>
                                </div>
                            ...
                            <?php
                            // Ülke seçeneklerini veritabanından çekiyoruz
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="adres" name="adres" value="<?= $snc->adres; ?>" placeholder="Gerekli ise doldurunuz.">
                                </div>
                            </div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        ...
        <br />
        <img width="100" src="<?= htmlspecialchars($avatar, ENT_QUOTES, 'UTF-8'); ?>" id="avatar_src">
    </div>
</div>
...
<script>
    jQuery(document).ready(function() {
        ...
        $('.summernote').summernote({
            height: 200, // editor yüksekliğini ayarlayın
            minHeight: null, // editor'ün minimum yüksekliğini ayarlayın
            maxHeight: null, // editor'ün maksimum yüksekliğini ayarlayın
            focus: true, // summernote başlatıldığında editör alanına odaklanır
