<?php
// Hata ve log işlemleri
try {
    // Veritabanı bağlantısı ve diğer gereksinimler burada initialize ediliyor.

    // GET parametrelerinin güvenli hale getirilmesi
    $id = $gvn->rakam($_GET["id"]);
    $goto = $gvn->harf_rakam($_GET["goto"]);

    // Veritabanı sorgusu
    $snc = $db->prepare("SELECT * FROM hesaplar WHERE site_id_555=999 AND id=:ids");
    $snc->execute(['ids' => $id]);
    ...
    $avatar = empty($snc->avatar) ? 'https://www.turkiyeemlaksitesi.com.tr/uploads/default-avatar.png' : 'https://www.turkiyeemlaksitesi.com.tr/uploads/thumb/' . $snc->avatar;

    // Üyelik türleri belirleme
    $turler = explode(",", dil("UYELIK_TURLERI"));
    if ($snc->turu == 2) {
        $kurumsal = $db->prepare("SELECT id, adi, soyadi, unvan FROM hesaplar WHERE site_id_555=999 AND id=?");
                ...
                <div class="col-lg-12">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane<?= ($goto == '') ? " active " : ''; ?>" id="tab1">
                            ...
                            <form role="form" class="form-horizontal" id="forms" method="POST" action="ajax.php?p=uye_duzenle&id=<?= $snc->id; ?>" onsubmit="return false;" enctype="multipart/form-data">
                                        ...
                                        <div id="uyekisiselbilgi" class="panel-collapse collapse in" aria-expanded="true">
                                            <div style="padding:20px;">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="checkbox checkbox-success">
                                                            ...
                                                            <label for="ilan_aktifet_check"><strong>Aktif</strong></label> <span style="font-size:14px;">(Eklenen ilanlar otomatik onaylanarak yayınlanır.)</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php if ($snc->turu == 2) { ?>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <span style="display:block; margin-top:6px;">
                                                                <a href="index.php?p=uye_duzenle&id=<?= $kurumsal->id; ?>"><?= (empty($kurumsal->unvan)) ? $kurumsal->adi . ' ' . $kurumsal->soyadi : $kurumsal->unvan; ?></a>
                                                            </span>
                                                        </div>
                                                    </div>
                                                <?php } ?>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="adsoyad" name="adsoyad" value="<?= $snc->adi . ' ' . $snc->soyadi; ?>" placeholder="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="nick_adi" class="col-sm-3 control-label">Profil URL</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="nick_adi" name="nick_adi" value="<?= $snc->nick_adi; ?>" placeholder="">
                                                    </div>
                                                </div>
                                                <?php if ($snc->tipi != 1) { ?>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" id="email" name="email" value="<?= $snc->email; ?>" placeholder="Buraya Emailinizi yazınız">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="dunvan" class="col-sm-3 control-label">Bağlı Olduğunuz Firma</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" id="dunvan" name="dunvan" value="<?= $snc->dunvan; ?>" placeholder="Bağlı Olduğunuz Firma Adını Yazınız">
                                                        </div>
                                                    </div>
                                                <?php } ?>
                                                <div class="form-group bireysel">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="tcno" name="tcno" value="<?= $snc->tcno; ?>" placeholder="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="webadres" class="col-sm-3 control-label">Web Adresi</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="webadres" name="webadres" value="<?= $snc->webadres; ?>" placeholder="Emlak Sitenizin Adını Yazınız">
                                                    </div>
                                                </div>
                                                <?php if ($snc->tipi != 1) { ?>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="password" class="form-control" id="parola" name="parola" value="<?= $snc->parola; ?>" placeholder="Parolanızı Yazınız">
                                                        </div>
                                                    </div>
                                                <?php } ?>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="telefon" name="telefon" value="<?= $snc->telefon; ?>" placeholder="Cep Telefonunuzu Yazınız">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="sabit_telefon" class="col-sm-3 control-label">Sabit Telefon</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="sabit_telefon" name="sabit_telefon" value="<?= $snc->sabit_telefon; ?>" placeholder="Sabit telefonunuz Yoksa Cep Telefonunuzu Yazınız. Yoksa İlanda Telefonunuz Gözükmez">
                                                    </div>
                                                </div>
                                                <div class="form-group kurumsal">
                                                    <label for="unvan" class="col-sm-3 control-label">Kurumsal Firma Adı</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="unvan" name="unvan" value="<?= $snc->unvan; ?>" placeholder="Site Sahibi İseniz Kurumsal Firma Adınızı Yazınız - Değilseniz BOŞ BIRAKIN">
                                                    </div>
                                                </div>
                                                <div class="form-group kurumsal">
                                                    <label for="vergi_no" class="col-sm-3 control-label">Vergi No</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="vergi_no" name="vergi_no" value="<?= $snc->vergi_no; ?>" placeholder="">
                                                    </div>
                                                </div>
                                                <div class="form-group kurumsal">
                                                    <label for="vergi_dairesi" class="col-sm-3 control-label">Vergi Dairesi</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="vergi_dairesi" name="vergi_dairesi" value="<?= $snc->vergi_dairesi; ?>" placeholder="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group danisman">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="checkbox checkbox-success">
                                                                ...
                                                                <label for="onecikar_check"><strong>Aktif</strong></label> <span>(Anasayfada "Öne Çıkan Danışmanlar"da yayınlanır.)</span><br>
                                                            </div>
                                                        </div>
                                                        <label class="col-sm-3 control-label"></label>
                                                        <div class="col-sm-3">
                                                            <input placeholder="Bitiş Tarihi (01.01.2017)" type="text" class="form-control" id="onecikar_btarih" name="onecikar_btarih" value="<?= ($snc->onecikar_btarih == '0000-00-00 00:00:00' || empty($snc->onecikar_btarih)) ? '' : date("d.m.Y", strtotime($snc->onecikar_btarih)); ?>">
                                                        </div>
                                                    </div>
                                                <?php } ?>
                                                <div class="form-group kurumsal danisman">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea class="summernote form-control" style="width:200px;" id="hakkinda" name="hakkinda"><?= $snc->hakkinda; ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group"<?= ($snc->tipi == 1) ? ' style="display:none"' : ''; ?>>
...
<?php
    ...
    // Hata mesajını hem logla hem de ekrana yazdır
    error_log("Veritabanı hatası: " . $e->getMessage());
    echo "<div class='alert alert-danger'>Bir hata oluştu. Lütfen daha sonra tekrar deneyiniz.</div>";
} catch (Exception $e) {
    // Genel hata mesajını hem logla hem de ekrana yazdır
            ...
            <div class="form-group kurumsal">
                ...
                <div class="col-sm-9">
                    ...
                    <div class="form-group" style="float:left; width:170px;">
                        ...
                        <div class="col-sm-11">
                            <input disabled class="form-control" id="map_il" value="<?= $il_adi; ?>" type="text">
                        </div><!-- col end -->
                    </div><!-- row end -->
                    ...
                    <div class="form-group" style="float:left; width:170px;">
                        ...
                        <div class="col-sm-11">
                            <input disabled id="map_ilce" class="form-control" value="<?= $ilce_adi; ?>" type="text">
                        </div><!-- col end -->
                    </div><!-- row end -->
                    ...
                    <div class="form-group" style="float:left; width:170px;">
                        ...
                        <div class="col-sm-11">
                            <input disabled onchange="yazdir();" type="text" id="map_mahalle" class="form-control" value="<?= $mahalle_adi; ?>">
                        </div><!-- col end -->
                    </div><!-- row end -->
...
<div class="form-group kurumsal">
                                            ...
                                            <div class="col-sm-1">
											<input type="text" name="danisman_limit" class="form-control" value="<?=$snc->danisman_limit;?>">
                                </div>
                                </div>
								...
								<div class="form-group">
                                            ...
                                            <div class="col-sm-1">
											<input type="text" name="aylik_ilan_limit" class="form-control" value="<?=$snc->aylik_ilan_limit;?>">
                                        </div>
                                        </div>
								...
								<div class="form-group">
                                            ...
                                            <div class="col-sm-1">
											<input type="text" name="ilan_resim_limit" class="form-control" value="<?=$snc->ilan_resim_limit;?>">
                                        </div>
                                        </div>
								...
								<div class="form-group">
                                            ...
                                            <div class="col-sm-1">
											<input type="text" name="ilan_yayin_sure" class="form-control" value="<?=$snc->ilan_yayin_sure;?>">
                                        </div>
										<div class="col-sm-2">
...
<div class="tab-pane" id="tab2">
    <div class="btn-group">
        <button type="button" class="btn btn-info waves-effect waves-light w-lg m-b-5" onclick="window.location.href='index.php?p=ilan_ekle&acid=<?= $snc->id; ?>';"> <i class="fa fa-plus"></i> Yeni Ekle</button>
    </div>
    ...
    <?php
    if ($snc->turu == 1) {
        $dids = $db->query("SELECT kid,id,GROUP_CONCAT(id SEPARATOR ',') AS danismanlar_19541956 FROM hesaplar WHERE site_id_555=999 AND kid=" . $snc->id)->fetch(PDO::FETCH_OBJ);
    ...
    $qry = $pagent->sql_query("SELECT * FROM sayfalar WHERE site_id_555=999 AND acid IN(" . $acids . ") AND ekleme=1 AND tipi=4 ORDER BY durum ASC, id DESC", $gvn->rakam($_GET["git"]), 500);
    ...
    ?>
            ...
            <tbody>
                ...
                ?>
                    <tr id="row_<?= $row->id; ?>">
                        ...
                        <td><strong><?= htmlspecialchars($fiyat . ' ' . $row->pbirim, ENT_QUOTES, 'UTF-8'); ?></strong></td>
                        <td>
                            <?php
                            if ($row->durum == 0) {
                        ...
                        <td>
                            <div class="btn-group dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="index.php?p=ilan_duzenle&id=<?= $row->id; ?>&acid=<?= $row->acid; ?>">Görüntüle / Düzenle</a></li>
                                    <li><a href="javascript:;" onclick="if(confirm('Bu işlemi gerçekten yapmak istiyor musunuz ?')){ajaxHere('ajax.php?p=ilanlar&id=<?= $row->id; ?>','form_status');}">Sil</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
        ...
        <?php if ($adet > 500) { ?>
            <div class="clear"></div>
            <div class="sayfalama">
                <?php echo $pagent->listele('index.php?p=uye_duzenle&id=' . $snc->id . '&git=', $gvn->rakam($_GET["git"]), $qry['basdan'], $qry['kadar'], 'class="sayfalama-active"', $query); ?>
            </div>
        <?php } ?>
    ...
    <div class="tab-pane" id="tab3">
        <table class="table table-hover mails datatable">
            ...
            <tbody>
                <?php
                $i = 0;
                $sorgu = $db->query("SELECT * FROM hesaplar WHERE site_id_555=999 AND kid=" . $snc->id . " ORDER BY id DESC LIMIT 0,500");
                while ($row = $sorgu->fetch(PDO::FETCH_OBJ)) {
                    $i += 1;
                ?>
                    <tr id="danismanrow_<?= $row->id; ?>">
                        <td style="display:none" class="mail-select"><?= $i; ?></td>
                        <td><b><a href="index.php?p=uye_duzenle&id=<?= $row->id; ?>"><?= htmlspecialchars($row->adi . ' ' . $row->soyadi, ENT_QUOTES, 'UTF-8'); ?></a></b></td>
                        ...
                        <td>
                            <div class="btn-group dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li><a href="javascript:;" onclick="DanismanSil(<?= $row->id; ?>);">Sil</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
...
<?php if ($snc->turu == 0 || $snc->turu == 1) { ?>
    <div class="tab-pane" id="tab4">
        <table class="table table-hover mails datatable">
            ...
            <tbody>
                <?php
                $sorgu = $db->query("SELECT * FROM upaketler_19541956 WHERE acid=" . $snc->id . " ORDER BY durum ASC,id DESC LIMIT 0,500");
                $i = 0;
                while ($row = $sorgu->fetch(PDO::FETCH_OBJ)) {
                    $i = $i + 1;
                ?>
...
<div class="tab-pane" id="tab5">
    <table class="table table-hover mails datatable">
        ...
        <tbody>
            ...
            $gids = array();
            $ilanlar = array();
            $sorgu = $db->query("SELECT * FROM dopingler_group_19541956 WHERE acid=" . $snc->id . " ORDER BY durum ASC,id DESC LIMIT 0,500");
            $x = 0;
            while ($row = $sorgu->fetch(PDO::FETCH_OBJ)) {
                $x += 1;
                $gids[] = $row;
            ...
            ?>
                <tr id="doping<?= $row->id; ?>">
                    ...
                    <td id="doping<?= $row->id; ?>_durum"><?php
                                                            echo ($row->durum == 0) ? '<strong style="color:red">Onay Bekliyor</strong>' : '';
                                                            echo ($row->durum == 1) ? '<strong style="color:green">Onaylandı</strong>' : '';
                                                            echo ($row->durum == 2) ? '<strong style="color:black">İptal Edildi</strong>' : '';
                                                            ?></td>
                    <td>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <select class="form-control" name="periyod[<?= $row->id; ?>]">
                                            <?php
                                            foreach ($periyod as $k => $v) {
                                            ?><option value="<?= $k; ?>" <?= ($row->periyod == $k) ? " selected" : ''; ?>><?= htmlspecialchars($v, ENT_QUOTES, 'UTF-8'); ?></option><?php
                                            }
                                            ?>
                                        </select>
                                    </div>
        ...
        <div class="col-md-3">
            ...
            <div class="contact-list nicescroll">
                <ul class="list-group contacts-list">
                    ...
                    $bid = $snc->id;
                    try {
                        $kisilerListe = $db->prepare("SELECT DISTINCT mr.* FROM mesajlar_19541956 AS mr INNER JOIN mesaj_iletiler_19541956 AS mi ON mi.mid = mr.id WHERE (mr.kimden=:idim OR mr.kime=:idim) AND ( (mr.kime=:idim) OR (mr.kimden=:idim)) ORDER BY mr.starih ASC");
                    ...
                    while ($row = $kisilerListe->fetch(PDO::FETCH_OBJ)) {
                        ...
                        $avatar = ($account->avatar == '') ? '/var/www/vhosts/turkiyeemlaksitesi.com.tr/turkiyeemlaksitesi.com.tr/uploads/default-avatar.png' : '/var/www/vhosts/turkiyeemlaksitesi.com.tr/turkiyeemlaksitesi.com.tr/uploads/thumb/' . $account->avatar;
                    ...
                    ?>
                        <li class="list-group-item<?= $aktifet; ?>">
                            <a href="javascript:SohbetGoster(<?= $acid; ?>);">
                                ...
                                <span class="name"><?= htmlspecialchars($adsoyad, ENT_QUOTES, 'UTF-8'); ?></span>
                            </a>
...
<div class="col-md-9">
<?php
$adsoyadim = ($snc->unvan != '') ? $snc->unvan : $snc->adi . " " . $snc->soyadi;
$avatarim = ($snc->avatar == '') ? '/var/www/vhosts/turkiyeemlaksitesi.com.tr/turkiyeemlaksitesi.com.tr/uploads/default-avatar.png' : '/var/www/vhosts/turkiyeemlaksitesi.com.tr/turkiyeemlaksitesi.com.tr/uploads/thumb/' . $snc->avatar;
...
?>
        <div class="chat-conversation">
            <ul class="conversation-list nicescroll" id="iletiler">
                ...
                $uyavatar = ($uye->avatar == '') ? '/var/www/vhosts/turkiyeemlaksitesi.com.tr/turkiyeemlaksitesi.com.tr/uploads/default-avatar.png' : '/var/www/vhosts/turkiyeemlaksitesi.com.tr/turkiyeemlaksitesi.com.tr/uploads/thumb/' . $uye->avatar;
                //$uyturu = $uturu[$uye->turu];
                $uyadsoyad = ($uye->unvan != '') ? $uye->unvan : $uye->adi . " " . $uye->soyadi;
                ...
                $miletiler = $db->prepare("SELECT DISTINCT mi.* FROM mesaj_iletiler_19541956 AS mi INNER JOIN mesajlar_19541956 AS mr ON mi.mid=mr.id WHERE mi.mid=:mesaj_id AND ((mr.kime=:bid) OR (mr.kimden=:bid)) ORDER BY id ASC");
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#iletiler').animate({
            scrollTop: $('#iletiler')[0].scrollHeight
        }, 500);
