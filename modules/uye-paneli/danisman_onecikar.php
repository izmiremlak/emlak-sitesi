...
<div class="uyeolgirisyap">
    ...
    <div style="text-align:center;margin-top:25px;">
        <a class="btn" href="javascript:;" onclick="ajaxHere('ajax.php?p=danisman_onecikar_siparis&id=<?= htmlspecialchars($danisman->id, ENT_QUOTES, 'UTF-8'); ?>&periyod=<?= htmlspecialchars($periyodu, ENT_QUOTES, 'UTF-8'); ?>&odeme=havale_eft','SipSonuc');"><?= htmlspecialchars(dil("TX544"), ENT_QUOTES, 'UTF-8'); ?> <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
        <div class="clear"></div>
        <div id="SipSonuc"></div>
    ...
    ?>
    <!-- SanalPos frame kodu -->
    <?php $fonk->paytr_frame(htmlspecialchars($hesap->adi . " " . $hesap->soyadi, ENT_QUOTES, 'UTF-8'), htmlspecialchars($hesap->email, ENT_QUOTES, 'UTF-8'), htmlspecialchars($hesap->adres, ENT_QUOTES, 'UTF-8'), htmlspecialchars($hesap->telefon, ENT_QUOTES, 'UTF-8'), htmlspecialchars($urunadi, ENT_QUOTES, 'UTF-8'), $ftutar, $oid); ?>
    ...
    <div id="OdemeButon" style="text-align:center;margin-top:25px;"><a class="btn" href="javascript:;" onclick="ajaxHere('ajax.php?p=danisman_onecikar_siparis&id=<?= htmlspecialchars($danisman->id, ENT_QUOTES, 'UTF-8'); ?>&periyod=<?= htmlspecialchars($periyodu, ENT_QUOTES, 'UTF-8'); ?>&odeme=paypal','SipSonuc');"><?= htmlspecialchars(dil("TX544"), ENT_QUOTES, 'UTF-8'); ?> <i class="fa fa-arrow-right" aria-hidden="true"></i></a></div>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            ?><option value="<?= htmlspecialchars($idi, ENT_QUOTES, 'UTF-8'); ?>" data-money="<?= htmlspecialchars($tutar, ENT_QUOTES, 'UTF-8'); ?>"><?php echo ($suresi != 0) ? htmlspecialchars($suresi, ENT_QUOTES, 'UTF-8') . " " : '1 '; echo htmlspecialchars($periyodu, ENT_QUOTES, 'UTF-8') . " " . htmlspecialchars($tutar, ENT_QUOTES, 'UTF-8'); ?> <?= htmlspecialchars(dil("DONECIKAR_PBIRIMI"), ENT_QUOTES, 'UTF-8'); ?></option><?php
            }
            ?>
            </select>
            </td>
    ...
    <h4 style="float:right;margin-top:25px;margin-bottom:25px;" id="ToplamOdenecek"><?= htmlspecialchars(dil("TX523"), ENT_QUOTES, 'UTF-8'); ?>: <strong><font id="toplam_tutar">0</font> <?= htmlspecialchars(dil("DONECIKAR_PBIRIMI"), ENT_QUOTES, 'UTF-8'); ?></strong></h4>
