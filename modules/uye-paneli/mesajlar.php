                ...
                <div class="mesajlasmalar">
                    ...
                    <div id="MesajlasmaContent" <?= ($uid == 0) ? 'style="display:none"' : ''; ?>>
                        <div class="uyemsjprofili">
                            ...
                            <h4><strong id="UyeAdiSoyadi"><?= htmlspecialchars($uyadsoyad, ENT_QUOTES, 'UTF-8'); ?></strong><br><span id="UyeTuru">(<?= htmlspecialchars($uyturu, ENT_QUOTES, 'UTF-8'); ?> <?= htmlspecialchars(dil("TX384"), ENT_QUOTES, 'UTF-8'); ?>)</span></h4>

                            <a href="<?= htmlspecialchars($uyeProLink, ENT_QUOTES, 'UTF-8'); ?>" id="UyeProLink" class="gonderbtn"><i class="fa fa-eye" aria-hidden="true"></i> <?= htmlspecialchars(dil("TX401"), ENT_QUOTES, 'UTF-8'); ?></a>

                            <a href="javascript:;" class="gonderbtn" id="EngelButon" onclick="EngelDurum();" <?= ($KarsiEngel == 1) ? 'style="display:none"' : ''; ?>><i class="fa fa-ban" aria-hidden="true"></i> <?= ($BenEngel == 1) ? htmlspecialchars(dil("TX402"), ENT_QUOTES, 'UTF-8') : htmlspecialchars(dil("TX403"), ENT_QUOTES, 'UTF-8'); ?></a>
                            <a href="javascript:;" class="gonderbtn" id="GorusmeSilButon" onclick="GorusmeyiSil();" <?= ($isileti == 0) ? 'style="display:none"' : ''; ?>><i class="fa fa-trash"></i> <?= htmlspecialchars(dil("TX404"), ENT_QUOTES, 'UTF-8'); ?></a>
                        </div>
                        ...
                        <div id="MesajEngeli" <?= ($KarsiEngel == 1 || $BenEngel == 1) ? 'style="display:block"' : 'style="display:none"'; ?>><?= htmlspecialchars(dil("TX406"), ENT_QUOTES, 'UTF-8'); ?></div>
