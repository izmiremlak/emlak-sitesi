...
$kontrol		= $db->prepare("SELECT id,concat_ws(' ',adi,soyadi) AS adsoyad,avatar,onecikar,onecikar_btarih FROM hesaplar WHERE site_id_555=999 AND id=? AND kid=?");
...
<input type="hidden" name="item_name" value="<? echo $fonk->eng_cevir($danisman->adsoyad." ".dil("PAY_NAME3")); ?>">
</FORM>
<?
