        ...
        <table width="100%" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td style="border-bottom-width: 1px; border-bottom-style: dotted; border-bottom-color: #CCC; padding:3px;" scope="col">
                    ...
                    <span style="font-size:14px; font-family:Calibri, Helvetica, sans-serif;">Bir kullanıcımız size mesaj gönderdi. Detaylı bilgi ve mesajı yanıtlamak için üye panelinizin "Mesajlarım" kısmını ziyaret edebilirsiniz.</span></p>
                    <p><strong><span style="font-family: Calibri, Helvetica, sans-serif; font-size: 14px; color: #D4701A">Detaylar;<br>----------------------------</span></strong><span style="font-family: Calibri, Helvetica, sans-serif; font-size: 14px"><br>Adı Soyadı: ' . $adsoyad . '<br>Telefon: ' . $hesap->telefon . '<br>E-Posta: ' . $hesap->email . '<br><br>Mesajı: ' . $mesaj . '<br><br><strong><span style="font-family: Calibri, Helvetica, sans-serif; font-size: 14px; color: #D4701A">---------------------------- </span></strong></span></p>
