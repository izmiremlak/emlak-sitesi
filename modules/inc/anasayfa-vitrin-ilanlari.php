...
<div class="list_carousel">
		...
		while($row	= $sql->fetch(PDO::FETCH_OBJ)){
			...
			$row_lang = $db->query("SELECT t1.id,t1.url,t1.fiyat,t1.baslik,t1.resim,t1.il_id,t1.ilce_id,t1.emlak_durum,t1.pbirim,t1.emlak_tipi,t1.ilan_no FROM sayfalar AS t1 WHERE site_id_555=999 AND ilan_no=".$row->ilan_no." AND dil='".$dil."' ");
