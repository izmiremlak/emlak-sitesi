...
<?php if (($p == 'sayfa' && $sayfay->tipi == 4) || ($p == 'sayfa' && $sayfay->tipi == 5)) { ?>
...
<style type="text/css">
    ...
    div.hgchd {
        _bottom: auto;
        _top: expression(ie6 = (document.documentElement.scrollTop ? document.documentElement.scrollTop : document.body.scrollTop) + 'px');
    }
</style>
<center>
    <a style="font-family:Arial;font-size:19px;color:#ff0000;"></a><br /><br />
    <img style="padding:0px;margin:0px;background-color:transparent;border:none;" src="<?= THEME_DIR; ?>images/loading.gif" alt="Loading..." title="yükleniyor" width="auto" height="auto" />
</center>
