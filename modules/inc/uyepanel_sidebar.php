...
<?php
$upaketleri = $db->query("SELECT id FROM upaketler_19541956 WHERE acid=" . intval($hesap->id));
$upaketleri = $upaketleri->rowCount();
?>
<a <?= ($upaketleri < 1) ? 'id="uyepaketlink" ' : ''; ?>class="btn<?= ($rd == "paketlerim" || $rd == "uyelik_paketi_satinal") ? ' uyeaktifbtn2' : ''; ?>" href="<?= ($upaketleri > 0) ? 'paketlerim' : 'uyelik-paketleri'; ?>"><i class="fa fa-trophy" aria-hidden="true"></i> <?= ($upaketleri > 0) ? htmlspecialchars(dil("TX657"), ENT_QUOTES, 'UTF-8') : htmlspecialchars(dil("TX476"), ENT_QUOTES, 'UTF-8'); ?></a>
<?php } ?>
...
<?php if ($hesap->turu == 1) { ?> 
<a class="btn" href="eklenen-danismanlar" <?= ($rd == "danismanlar" || $rd == "danisman_ekle" || $rd == "danisman_duzenle") ? 'id="uyeaktifbtn"' : ''; ?>><i class="fa fa-briefcase" aria-hidden="true"></i> <?= htmlspecialchars(dil("TX485"), ENT_QUOTES, 'UTF-8'); ?></a>
<?php } ?>
<a class="btn" href="favori-ilanlar" <?= ($rd == "favori_ilanlar") ? 'id="uyeaktifbtn"' : ''; ?>><i class="fa fa-heart" aria-hidden="true"></i> <?= htmlspecialchars(dil("TX436"), ENT_QUOTES, 'UTF-8'); ?></a>
<?php if ($gayarlar->anlik_sohbet == 1) { ?>
<a class="btn" href="mesajlar" <?= ($rd == "mesajlar") ? 'id="uyeaktifbtn"' : ''; ?>><span style="margin-left: -29px; position: absolute; margin-top: -15px; display: none;" class="msjvar mbildirim">0</span><i class="fa fa-envelope" aria-hidden="true"></i> <?= htmlspecialchars(dil("TX394"), ENT_QUOTES, 'UTF-8'); ?></a>
<?php } ?>
<a class="btn" href="uye-paneli" <?= ($rd == '') ? 'id="uyeaktifbtn"' : ''; ?>><i class="fa fa-user" aria-hidden="true"></i> <?= htmlspecialchars(dil("TX109"), ENT_QUOTES, 'UTF-8'); ?></a>
</div>