...
<div class="gelismisara">
    <form action="ajax.php?p=ilanlar" method="POST" id="IlanlarAramaForm">
        ...
        <input name="min_bina_kat_sayisi" type="text" value="<?= ($min_bina_kat_sayisi != 0) ? htmlspecialchars($min_bina_kat_sayisi, ENT_QUOTES, 'UTF-8') : ''; ?>" id="yariminpt" placeholder="<?= htmlspecialchars(dil("TX64"), ENT_QUOTES, 'UTF-8'); ?>" class="konut">
        <input name="max_bina_kat_sayisi" type="text" value="<?= ($max_bina_kat_sayisi != 0) ? htmlspecialchars($max_bina_kat_sayisi, ENT_QUOTES, 'UTF-8') : ''; ?>" id="yariminpt" placeholder="<?= htmlspecialchars(dil("TX65"), ENT_QUOTES, 'UTF-8'); ?>" class="konut">
