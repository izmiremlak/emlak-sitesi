                    ...
                    <table width="100%" border="0">
                        <tr>
                            <td align="center" style="border:none;">
                                ...
                                <br>
                                <a href="javascript:;" onClick="AjaxFormS('KaydolForm','Gonay_snc');" class="mobilonaybtn"><i style="margin-right:5px;" class="fa fa-check"></i> <?= htmlspecialchars(dil('TX380'), ENT_QUOTES, 'UTF-8'); ?></a>
