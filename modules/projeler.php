...
<div class="sehirbutonlar" id="projeler">
    ...
    <?php
    $qry = $pagent->sql_query("SELECT id, url, baslik, resim FROM sayfalar WHERE site_id_555=888 AND tipi=5 AND dil='" . htmlspecialchars($dil, ENT_QUOTES, 'UTF-8') . "' ORDER BY id DESC", (int)$gvn->rakam($_GET["git"]), 6);
