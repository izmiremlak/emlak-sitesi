...
<div id="wrapper">
    <div class="content" id="bigcontent">
        ...
        <?php
        $qry = $pagent->sql_query("SELECT id,kid,adi,soyadi,avatar,avatard,nick_adi FROM hesaplar WHERE site_id_555=999 AND durum=0 AND turu=2 ORDER BY CASE WHEN onecikar_btarih>NOW() THEN 1 ELSE 2 END,id DESC");
