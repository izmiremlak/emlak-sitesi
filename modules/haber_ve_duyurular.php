...
<div id="wrapper">
    <div class="content" <?= ($gayarlar->haberler_sidebar == 0) ? 'id="bigcontent"' : '';?>>
        ...
        <?php
        $qry = $pagent->sql_query("SELECT * FROM sayfalar WHERE site_id_555=888 AND tipi=2 AND dil='" . htmlspecialchars($dil, ENT_QUOTES, 'UTF-8') . "' ORDER BY id DESC", $gvn->rakam($_GET["git"]), 5);
