...
try{
$query				= $db->prepare("UPDATE upaketler_19541956 SET adi=?,durum=?,odeme_yontemi=?,tutar=?,sure=?,periyod=?,btarih=?,aylik_ilan_limit=?,ilan_resim_limit=?,ilan_yayin_sure=?,ilan_yayin_periyod=?,danisman_limit=?,danisman_onecikar=?,danisman_onecikar_sure=?,danisman_onecikar_periyod=? WHERE id=?");
$query->execute(array($adi,$durum,$odeme_yontemi,$tutar,$sure,$periyod,$btarih,$aylik_ilan_limit,$ilan_resim_limit,$ilan_yayin_sure,$ilan_yayin_periyod,$danisman_limit,$danisman_onecikar,$danisman_onecikar_sure,$danisman_onecikar_periyod,$id));
