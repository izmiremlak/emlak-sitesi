...
#file_put_contents("a.txt",'POST dönmedi');
}
...
echo("Ödeme Gerçekleşemedi.");
#file_put_contents("a.txt","Geçersiz Token");
die();
}

if($fonk->bosluk_kontrol($customs) == true){
die("ERR CSTMERR");
#file_put_contents("a.txt","ERR CSTMERR");
}
...
#file_put_contents("a.txt","Geçersiz bir CUSTOM geld..");
}