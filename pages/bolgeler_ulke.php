...
?>            <div class="content">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="pull-left page-title">Ülke: <?=$snc->ulke_adi;?></h4>
...
<form role="form" class="form-horizontal"  id="forms" method="POST" action="ajax.php?p=bolgeler_il_ekle&ulke_id=<?=$snc->id;?>" onsubmit="return false;" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="btn-toolbar" role="toolbar">
                                        ...
                                        <div class="btn-group">
										<button type="button" class="btn btn-info waves-effect waves-light w-lg m-b-5" data-toggle="modal" data-target="#VeriEkle"> <i class="fa fa-plus"></i> Yeni İl Ekle</button>
...
<div id="form_statuss"></div>
                                    <form role="form" class="form-horizontal"  id="formss" method="POST" action="ajax.php?p=bolgeler_ulke&id=<?=$snc->id;?>" onsubmit="return false;" enctype="multipart/form-data">
                                        
                                        <div class="form-group">
                                            <label for="ulke_adi" class="col-sm-3 control-label">Ülke Adı</label>
                                            <div class="col-sm-9">
											<input type="text" class="form-control" id="ulke_adi" name="ulke_adi" value="<?=$snc->ulke_adi;?>" placeholder="">
                                        </div>
                                        </div>
...
<input type="hidden" name="action" value="" id="action_hidden">			
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="index.php?p=bolgeler_il&id=<?=$row->id;?>">Düzenle</a></li>
                                            <li><a href="index.php?p=bolgeler_ulke&id=<?=$snc->id;?>&sil=<?=$row->id;?>">Sil</a></li>
                                        </ul>
                                    </div>
