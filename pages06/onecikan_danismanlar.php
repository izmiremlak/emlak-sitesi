...
if($sil != ""){
$thi			= $db->query("SELECT did FROM onecikan_danismanlar_19541956 WHERE id=".$sil)->fetch(PDO::FETCH_OBJ);
...
$sip			= $db->query("SELECT * FROM onecikan_danismanlar_19541956 WHERE id=".$onayla)->fetch(PDO::FETCH_OBJ);
$hesapp			= $db->query("SELECT * FROM hesaplar WHERE site_id_555=999 AND id=".$sip->acid)->fetch(PDO::FETCH_OBJ);
$danisman		= $db->query("SELECT id,concat_ws(' ',adi,soyadi) AS adsoyad FROM hesaplar WHERE site_id_555=999 AND id=".$sip->did)->fetch(PDO::FETCH_OBJ);
...
$thi			= $sip;
$btarih			= $thi->btarih;
$db->query("UPDATE onecikan_danismanlar_19541956 SET durum='1' WHERE site_id_555=999 AND id=".$onayla." ");
...
$id			= $gvn->rakam($id);
if($action == "sil"){
$thi			= $db->query("SELECT did FROM onecikan_danismanlar_19541956 WHERE id=".$id)->fetch(PDO::FETCH_OBJ);
$db->query("DELETE FROM onecikan_danismanlar_19541956 WHERE site_id_555=999 AND id=".$id." ");
$db->query("UPDATE hesaplar SET onecikar='0',onecikar_btarih='' WHERE site_id_555=999 AND id=".$thi->did);
}elseif($action == "onayla"){

$sip			= $db->query("SELECT * FROM onecikan_danismanlar_19541956 WHERE site_id_555=999 AND id=".$id)->fetch(PDO::FETCH_OBJ);
$hesapp			= $db->query("SELECT * FROM hesaplar WHERE site_id_555=999 AND id=".$sip->acid)->fetch(PDO::FETCH_OBJ);
$danisman		= $db->query("SELECT id,concat_ws(' ',adi,soyadi) AS adsoyad FROM hesaplar WHERE site_id_555=999 AND id=".$sip->did)->fetch(PDO::FETCH_OBJ);
