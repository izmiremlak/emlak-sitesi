...
header("Location:index.php?p=mail_sablonlar_19541956 SET"); 
}
...
<ol class="breadcrumb pull-right"><li><a href="" onclick="window.history.back()"><i class="fa fa-angle-double-left"></i> Bildirim Şablonları</a></li><li class="active">Bildirim Şablonu Düzenle</li></ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <form role="form" class="form-horizontal"  id="forms" method="POST" action="ajax.php?p=mail_sablon_duzenle&id=<?=$snc->id;?>" onsubmit="return false;" enctype="multipart/form-data">
                                        
										<div class="form-group">
                                            <label class="col-sm-3 control-label">Şablon Adı</label>
                                            <div class="col-sm-9">
											<span style="margin-top: 9px;height: 25px;display: block;">
											<strong><?=$snc->adi;?></strong>
											</span>
										</div>
                                        </div>
										...
										<div class="form-group" style="display:none">
                                            <label class="col-sm-3 control-label">Şablon Adı</label>
                                            <div class="col-sm-9">
											<input type="text" class="form-control" name="adi" value="<?=$snc->adi;?>" placeholder="">
                                        </div>
                                        </div>
										...
										<div class="form-group" style="display:none">
                                            ...
                                            <div class="col-sm-9">
											<textarea class="form-control" rows="9" id="degiskenler" name="degiskenler"><?=$snc->degiskenler;?></textarea>
                                        </div>
                                        </div>
										...
										<div class="form-group" style="display:none">
                                            ...
                                            <div class="col-sm-9">
											<input type="text" class="form-control" name="yemails" value="<?=$snc->yemails;?>" placeholder="Virgül ile ayırarak yazınız.">
										...
										<div class="form-group" style="display:none">
                                            ...
                                            <div class="col-sm-9">
											<input type="text" class="form-control" name="yphones" value="<?=$snc->yphones;?>" placeholder="Virgül ile ayırarak yazınız.">
                                    ...
                                    <div class="radio radio-info radio-inline">
										...
										<div class="form-group ubildirim" <?=($snc->ubildirim != 1) ? 'style="display:none"' : '';?>>
                                            ...
                                            <div class="col-sm-9">
											<input type="text" class="form-control" id="konu" name="konu" value="<?=$snc->konu;?>" placeholder="">
                                        </div>
                                        </div>
										...
										<div class="form-group abildirim" <?=($snc->abildirim != 1) ? 'style="display:none"' : '';?>>
                                            ...
                                            <div class="col-sm-9">
											<input type="text" class="form-control" id="konu2" name="konu2" value="<?=$snc->konu2;?>" placeholder="">
                                        </div>
                                        </div>
										...
										<div class="form-group abildirim" <?=($snc->abildirim != 1) ? 'style="display:none"' : '';?>>
                                            ...
                                            <div class="col-sm-10">
											<textarea class="summernote form-control" rows="9" id="icerik2" name="icerik2"><?=$snc->icerik2;?></textarea>
                                        </div>
                                        </div>
										...
										<div class="form-group sbildirim" <?=($snc->sbildirim != 1) ? 'style="display:none"' : '';?>>
                                            ...
                                            <div class="col-sm-10">
											<textarea class="form-control" rows="9" id="icerik3" name="icerik3"><?=$snc->icerik3;?></textarea>
                                        </div>
                                        </div>
										...
										<div class="form-group ysbildirim" <?=($snc->ysbildirim != 1) ? 'style="display:none"' : '';?>>
                                            ...
                                            <div class="col-sm-10">
											<textarea class="form-control" rows="9" id="icerik4" name="icerik4"><?=$snc->icerik4;?></textarea>
                                        </div>
                                        </div>
