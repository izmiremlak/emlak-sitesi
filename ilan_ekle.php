<?php
// İlan numarası oluşturuluyor
$ilan_no = rand(10000000, 99999999);

// Gelen parametreler kontrol ediliyor ve güvenli hale getiriliyor
$acid = $gvn->rakam($_GET["acid"]);
$id = $gvn->rakam($_GET["id"]);

if ($id != '') {
    // Sayfa bilgileri veritabanından çekiliyor
...
<div class="content">
    <div class="container">
            ...
            <div class="panel panel-pink panel-color">
                ...
                <div id="collapseOne-2" class="panel-collapse collapse" aria-expanded="true">
                    <div class="panel-body">
                        ...
                        <font color="black">Elinizdeki Sözleşmeli İlanlarınızı <font color="red">Üyelerimiz</font> <font color="black">ile Paylaşabilir, Onların Paylaştığı Sözleşmeli İlanları, Kendi İlanınız gibi, Müşterilerinize Sunabilirsiniz.</font><br/><font color="red"><strong>ÖNEMLİ:</strong></font> <font color="black">Paylaştığınız İlanlar, Paylaştığınız Üyelerin sitelerinde Yayınlanacağı için İlanın içinde Sizi Çağrıştıracak, Firma İsmi, Telefon, Logo vs Olmamasına Lütfen Dikkat Ediniz.<br/>İlan Açıklamanızın en altına</font> <font color="red"><strong>Bu İlan, Yetkilisi Tarafından Paylaşıma Açılmıştır</strong></font> Yazınız.</font><br/><br/>
                        ...
                        <font color="black">İsterseniz, Birlikte Çalıştığınız Emlakçılar ve Emlak Danışmanları ile Grup Oluşturarak, Aranızda Paylaşabilirsiniz.</font><br/>
        ...
        <style>
            .form-group .ilanozellik span {
                color: #555;
            }
            .form-group .ilanozellik span label input {
                float: left;
                margin-right: 5px;
            }
        </style>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="ilanasamalar">
                            ...
                            <?php if ($gayarlar->dopingler_19541956 == 1) { ?><div class="ilanasamax"><center><h3>4</h3><div class="clear"></div><?=dil("TX531");?></center></div><?php } ?>
                            <div class="ilanasamax islem_tamam"><center><h3><?=($gayarlar->dopingler_19541956 == 1) ? 5 : 4;?></h3><div class="clear"></div><?=dil("TX532");?></center></div>
                        </div>
                        <!-- İlan Aşamaları END -->

                        <?php
                        $asama = $gvn->rakam($_GET["asama"]);
                                    ...
                                    <li class="uk-nestable-item" data-id="<?= $i; ?>" data-idi="<?= $row->id; ?>" id="foto_<?= $row->id; ?>">
                                        <div class="col-sm-6 col-lg-3 col-md-4 webdesign illustrator" id="foto_<?= $row->id; ?>">
                                            <div class="gal-detail thumb">
                                                ...
                                                <a style="margin-top: -60px; margin-right: 40px; float: right;" href='javascript:window.open("<?= SITE_URL . "rotate/" . $row->id; ?>", "mywindow", "status=1,toolbar=0,resizable=1,width=" + window.innerWidth + ",height=" + window.innerHeight + 100 + "").moveTo(0, 0);'><button type="button" class="btn btn-icon waves-effect waves-light btn-info m-b-5"><i class="fa fa-repeat" aria-hidden="true"></i></button></a>
                                            </div>
                                        </div>
                                    </li>
                                    <?php } ?>
                        ...
                        <div align="right">
                            ...
                            <a class="btn btn-warning waves-effect waves-light" href="javascript:skipPhotoStep();">Fotoğraf Yüklemeden Devam Et <i class="fa fa-arrow-right"></i></a>
                        </div>
                        </form>
                        ...
                        function skipPhotoStep() {
                            window.location.href = 'index.php?p=ilan_ekle&id=<?= $id; ?>&asama=1';
                        }
                        </script>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <select name="kimden" class="form-control">
            ...
            <?php
            foreach ($exp as $row) {
            ?><option><?= htmlspecialchars($row, ENT_QUOTES, 'UTF-8'); ?></option><?php
            }
            ?>
        </select>
    </div>
...
<div class="form-group" id="site_id_702_con">
    ...
    <div class="col-sm-9">
        ...
        <input type="text" class="form-control" id="site_id_702" name="site_id_702" value="<?= htmlspecialchars($snc->site_id_702, ENT_QUOTES, 'UTF-8'); ?>">
    </div>
</div>
</table>
...
<div class="ilanozellik tipi_konut">
    ...
    ?>
    <span><label style="font-weight:normal;"><input name="cephe_ozellikler[]" value="<?= htmlspecialchars($val, ENT_QUOTES, 'UTF-8'); ?>" type="checkbox"> <?= htmlspecialchars($val, ENT_QUOTES, 'UTF-8'); ?></label></span>
    <?php
    }
    ?>
</div>
