                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <form role="form" class="form-horizontal"  id="forms" method="POST" action="ajax.php?p=reklam_duzenle&id=<?=$snc->id;?>" onsubmit="return false;" enctype="multipart/form-data">
                                    <?if($snc->suresiz==0){?>  
									...
									?><option value="<?=$id;?>" <?=($snc->tipi == $id) ? "selected" : '';?>><?=$name;?></option><?
									}
									?>
									</select>
									</div>
									...
									<div class="col-sm-9">
									<textarea name="kodu" id="kodu" class="form-control"><?=$snc->kodu;?></textarea>
									...
									<div class="col-sm-9">
									<textarea name="mobil_kodu" id="mobil_kodu" class="form-control"><?=$snc->mobil_kodu;?></textarea>
									<span>Responsive (Telefon,Table,TV) için kaynak kod</span>
									</div>
									</div>
