                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="btn-toolbar" role="toolbar">
                                        ...
                                        <div class="btn-group">
										<button type="button" class="btn btn-info waves-effect waves-light w-lg m-b-5" onclick="window.location.href='index.php?p=ablok_ekle';"> <i class="fa fa-plus"></i> Yeni Ekle</button>
...
if($sil != ""){
$db->query("DELETE FROM abloklar WHERE id=".$sil." ");
...
?>
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="index.php?p=ablok_duzenle&id=<?=$row->id;?>">Düzenle</a></li>
                                            <li><a href="index.php?p=abloklar&sil=<?=$row->id;?>">Sil</a></li>
                                        </ul>
                                    </div>
