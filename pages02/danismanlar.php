                ...
                <div class="container">
                    ...
                    <div class="panel panel-pink panel-color"> 
                                        ...
                                        <div id="collapseOne-2" class="panel-collapse collapse" aria-expanded="true"> 
                                            ...
                                            Eklenen her ilana zorunlu olarak bir danışman atamak gerekmektedir. Bu herhangi bir kişi olmak zorunda değildir. Tüzel kişilik olarak da firma logo ve firma adınızı ve iletişim bilgilerinizi danışman olarak tanımlayabilirsiniz.<br><br>
                                            Ayrıca, üyelerin ekledikleri ilanlara kendi danışmanınızı tanımlayabilirsiniz. Böylelikle ilanla ilgilenen alıcılar, direkt olarak sizinle irtibat sağlayacaktır. (Ayrıca, danışman olarak üyenin kendi iletişim bilgilerini de gösterebilirsiniz.)
                                            </div> 
                                        </div> 
                                    </div>
                     </div> 
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="btn-toolbar" role="toolbar">
                                        ...
                                        <div class="btn-group">
										<button type="button" class="btn btn-info waves-effect waves-light w-lg m-b-5" onclick="window.location.href='index.php?p=danisman_ekle';"> <i class="fa fa-plus"></i> Yeni Ekle</button>
										
										</div>
										
										<!--div class="btn-group">
										<button type="button" class="btn btn-info waves-effect waves-light w-lg m-b-5" onclick="window.location.href='index.php?p=referans_kategoriler';"> <i class="fa fa-table"></i> Kategoriler</button>
...
$id			= $gvn->rakam($id);
if($action == 'sil'){
$db->query("DELETE FROM danismanlar_19541956 WHERE id=".$id);
}
} // FOREACH END
} // eğer varsa
...
?>
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            ...
                                            <li><a href="index.php?p=danismanlar&sil=<?=$row->id;?>">Sil</a></li>
                                        </ul>
                                    </div>
