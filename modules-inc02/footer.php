...
<?php
if($dayarlar->foot_sayfa1 != 0){$sayfa1 = $db->query("SELECT id,url FROM sayfalar WHERE site_id_555=888 AND id=".$dayarlar->foot_sayfa1)->fetch(PDO::FETCH_OBJ);}
if($dayarlar->foot_sayfa2 != 0){$sayfa2 = $db->query("SELECT id,url FROM sayfalar WHERE site_id_555=888 AND id=".$dayarlar->foot_sayfa2)->fetch(PDO::FETCH_OBJ);}
if($dayarlar->foot_sayfa3 != 0){$sayfa3 = $db->query("SELECT id,url FROM sayfalar WHERE site_id_555=888 AND id=".$dayarlar->foot_sayfa3)->fetch(PDO::FETCH_OBJ);}
if($dayarlar->foot_sayfa4 != 0){$sayfa4 = $db->query("SELECT id,url FROM sayfalar WHERE site_id_555=888 AND id=".$dayarlar->foot_sayfa4)->fetch(PDO::FETCH_OBJ);}
if($dayarlar->foot_sayfa5 != 0){$sayfa5 = $db->query("SELECT id,url FROM sayfalar WHERE site_id_555=888 AND id=".$dayarlar->foot_sayfa5)->fetch(PDO::FETCH_OBJ);}
if($dayarlar->foot_sayfa6 != 0){$sayfa6 = $db->query("SELECT id,url FROM sayfalar WHERE site_id_555=888 AND id=".$dayarlar->foot_sayfa6)->fetch(PDO::FETCH_OBJ);}
if($dayarlar->foot_sayfa7 != 0){$sayfa7 = $db->query("SELECT id,url FROM sayfalar WHERE site_id_555=888 AND id=".$dayarlar->foot_sayfa7)->fetch(PDO::FETCH_OBJ);}
