    ...
    <div class="wrapper-page">
        <div class="panel panel-color panel-primary panel-pages">
            <div class="panel-heading bg-img" style="background-color:#333;">
                ...
                <h3 class="text-center m-t-10 text-white">Parolamı Hatırlat</h3></div>
                ...
                <form method="post" action="ajax.php?p=forget_password" role="form" class="text-center" id="ForgetPassword" method="POST" onsubmit="return false;">
                    <div class="form-group m-b-0">
                        <div class="input-group">
                            <input type="text" class="form-control input-lg" placeholder="Kayıtlı e-posta adresiniz" name="email"> <span class="input-group-btn"><button type="submit" class="btn btn-lg btn-primary waves-effect waves-light" onclick="AjaxFormS('ForgetPassword','forget_status');">Gönder</button></span></div>
                    </div>
