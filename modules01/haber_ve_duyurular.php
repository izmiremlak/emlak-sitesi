...
<div class="headerbg" <?=($gayarlar->haber_ve_duyurular_resim  != '') ? 'style="background-image: url(uploads/'.$gayarlar->haber_ve_duyurular_resim.');"' : ''; ?>>
<div id="wrapper">
<div class="headtitle">
<h1><?=dil("TX135");?></h1>
<div class="sayfayolu">
<a href="index.html"><?=dil("TX136");?></a> / <span><strong><?=dil("TX135");?></strong></span>
</div>
</div>
...
$qry		= $pagent->sql_query("SELECT * FROM sayfalar WHERE site_id_555=888 AND tipi=2 AND dil='".$dil."' ORDER BY id DESC",$gvn->rakam($_GET["git"]),5);
...
<? }else{ ?>
<b style="color:#aa1818;"><?=dil("TX138");?></b>
<? } ?> 
