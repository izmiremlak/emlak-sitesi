...
<font color="black">Elinizdeki Sözleşmeli İlanlarınızı<font color="red"> Üyelerimiz</font> <font color="black">ile Paylaşabilir, Onların Paylaştığı Sözleşmeli İlanları, Kendi İlanınız gibi, Müşterilerinize Sunabilirsiniz. </font><br/><font color="red"><strong> ÖNEMLİ : </strong></font> <font color="black">Paylaştığınız İlanlar, Paylaştığınız Üyelerin sitelerinde Yayınlanacağı için 
...
<?if($gayarlar->dopingler_19541956==1){?><div class="ilanasamax"><center><h3>4</h3><div class="clear"></div><?=dil("TX531");?></center></div><?}?>
...
<form action="ajax.php?p=galeri_video_guncelle&ilan_id=<?=$snc->id;?>&from=insert<? echo($snc->video!='') ? '&video=1' : '&video=0';?>" method="POST" id="VideoForm" enctype="multipart/form-data">
...
if($asama == 2 AND $gayarlar->dopingler_19541956 == 1){
