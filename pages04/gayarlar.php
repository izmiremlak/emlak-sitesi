...
Logo enfazla 15px x 15 px olmalı
                             ...
                             <div class="col-md-6">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body" style="height:150px;">
                                    <div class="form-group">
                                            <label for="favicon" class="col-sm-3 control-label">Watermark</label>
                                            <div class="col-sm-9">
											<input type="file" class="form-control" id="watermark" name="watermark">
											<br />
											<a target="_blank" href="../watermark.png"><img style="background:#333;float:left;margin-right:5px;" src="../watermark.png" id="watermark_src" height="50" /></a><span style="font-size:14px;margin-top:5px;">Yükleyeceğiniz görsel 800x600 Px boyutlarında, arka planı transparan ve hafif silik yazı veya logo içermelidir. 
</span>
											</div>
                                        </div>
                                    </div>
...
<div class="panel-group panel-group-joined" id="accordion-test"><!--accordion genel -->
...
<div style="padding:20px;">
  <div class="form-group">
                                            ...
                                            <span style="font-size:14px;">Site ilk açılışta görüntülenecek dil. (Otomatik seçilirse, ziyaretçi lokasyonuna göre uygun olan dil otomatik gösterilir.)</span>
											</div>
                                        </div>
								...
								<label style="float:left;margin-right:10px;" for="permalink_check" class="stm-checkbox-label"></label><span style="margin-left:10px;font-size:14px;margin-top:5px;">(Seo url ayarıdır. Örn: domain.com/sayfa-baslik.html (Arapça ve rusça gibi dillerde pasif edilmelidir.)</span>
								...
								<span style="margin-left:10px;font-size:14px;margin-top:5px;">(Aktif edildiğinde ilan görsellerine yükleyeceğiniz watermark görseli basılmaktadır.)</span>
									...
									<div class="form-group">
                                            ...
                                            <label for="site_ssl_check"><STRONG>Aktif</STRONG> </label> <span style="font-size:14px;"> (Sitenizi Https üzerinden çalıştıracaksanız bu seçeneği aktif ediniz.)</span>
                                        </div>
								...
								<div class="form-group">
                                            ...
                                            <label for="site_www_check"><STRONG>Aktif</STRONG></label> <span style="font-size:14px;">(Sitenizin başına otomatik www. eklenmesini isterseniz aktif ediniz.)</span>
                                        </div>
								...
								<div class="form-group">
                                            ...
                                            <label for="uyelik_check"><STRONG>Aktif</STRONG></label>  <span style="font-size:14px;">(Ziyaretçileriniz hesap oluşturarak ilan ekleyebilir. Pasif edilirse hesap oluşturamazlar. Sadece sizin oluşturduğunuz hesaplar giriş yapabilir.)</span>
                                        </div>
                               ...
                               <div class="form-group">
                                            ...
                                            <label for="sms_aktivasyon_check"><STRONG>Aktif</STRONG></label> <span style="font-size:14px;">(Üyelik esnasında mobil onay istenir. Sms paketinizin olması gerekir.)</span>
                                        </div>
							   ...
							   <div class="form-group">
                                            ...
                                            <label for="dopingler_19541956_check"><STRONG>Aktif</STRONG></label>  <span style="font-size:14px;">(İlanlara doping özelliği vererek kazanç sağlayın.)</span>
                                        </div>
...
<div class="form-group" style="display:none">
						   ...
						   <form role="form" class="form-horizontal" id="tab2_form" method="POST" action="ajax.php?p=dayarlar" onsubmit="return false;" enctype="multipart/form-data">
									...
									<div class="form-group">
                                            <label for="google_maps" class="col-sm-3 control-label">Google Maps
                                            <br><span style="font-weight:lighter;font-size:14px;">Harita üzerindeki işaretçiyi tutup istediğiniz alana sürükleyip bırakınız. </span></label>
