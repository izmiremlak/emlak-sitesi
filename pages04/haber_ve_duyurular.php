...
?>
										...
										<tbody>
										<?php
										$sorgu		= $db->query("SELECT * FROM sayfalar WHERE site_id_555=888 AND tipi=2 AND dil='".$dil."' ORDER BY id DESC LIMIT 0,500");
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="index.php?p=haber_ve_duyuru_duzenle&id=<?=$row->id;?>">Düzenle</a></li>
                                            <li><a href="index.php?p=haber_ve_duyurular&sil=<?=$row->id;?>">Sil</a></li>
                                        </ul>
                                    </div>
