                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <form role="form" class="form-horizontal"  id="forms" method="POST" action="ajax.php?p=video_kategori_duzenle&id=<?=$snc->id;?>" onsubmit="return false;" enctype="multipart/form-data">
